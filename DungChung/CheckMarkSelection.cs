...
namespace DevExpress.XtraGrid.Selection
{
    ...
    public class CheckMarksSelection
    {
        ...
        public string fieldName = "Check";

        public CheckMarksSelection()
        {
            selection = new ArrayList();
        }

        public CheckMarksSelection(GridView view)
            : this()
        {
            View = view;
        }
        ...
        public void ClearSelection()
        {
            ...
            {
                _view.SetRowCellValue(i, _view.Columns[0],false);
            }
            selection.Clear();
            Invalidate();
        }
        public void SelectAll()
        {
            ...
            for (int i = 0; i < _view.DataRowCount; i++)
            {
                _view.SetRowCellValue(i, _view.Columns[0], true);
        ...
        {
            _view.SetRowCellValue(rowHandle, _view.Columns[0], select);
        ...
        void View_CustomDrawGroupRow(object sender, RowObjectCustomDrawEventArgs e)
        {
            ...
            checkRect.Offset(checkRect.Width + CheckboxIndent * 2 - 1, -2);
            DrawCheckBox(e.Graphics, checkRect, IsGroupRowSelected(e.RowHandle));
