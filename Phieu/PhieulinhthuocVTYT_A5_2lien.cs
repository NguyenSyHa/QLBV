...
{
    public partial class PhieulinhthuocVTYT_A5_2lien : DevExpress.XtraReports.UI.XtraReport
    {
        int _dongy = 0;
        public PhieulinhthuocVTYT_A5_2lien()
        {
            InitializeComponent();
        }
        public PhieulinhthuocVTYT_A5_2lien(int dy)
        {
            InitializeComponent();
            _dongy = dy;
        }
