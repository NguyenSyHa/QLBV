...
{
    public partial class repPhieuKBVV_THa_Mat : DevExpress.XtraReports.UI.XtraReport
    {
        public repPhieuKBVV_THa_Mat()
        {
            InitializeComponent();
        }
        ...
        private void ReportHeader_BeforePrint(object sender, CancelEventArgs e)
        {
            ...
            {
                txtCapCuu.Text = txtCapCuu1.Text = "";
            ...
            if (Tuoi.Value != null && Tuoi.Value.ToString().ToLower().Contains("tháng"))
            {
                labTuoi.Text = labTuoi1.Text = "Tháng";
            }
            if (Tuoi.Value != null && Tuoi.Value.ToString().ToLower().Contains("ngày"))
            {
            ...
            else if (NgoaiKieu.Value != null && NgoaiKieu.Value.ToString() == "1")
            {
            ...
            if (SThe.Value != null && SThe.Value.ToString() != "" && SThe.Value.ToString().Length >= 15)
            {
                ...
                col11.Text = SThe.Value.ToString().Substring(0, 2);
                col12.Text = SThe.Value.ToString().Substring(2, 1);
                col13.Text = SThe.Value.ToString().Substring(3, 2);
                col14.Text = SThe.Value.ToString().Substring(5, 2);
                col15.Text = SThe.Value.ToString().Substring(7, 3);
                col16.Text = SThe.Value.ToString().Substring(10, 5);
            }
