...
{
    public partial class repBangKeCPNgoaiBH : DevExpress.XtraReports.UI.XtraReport
    {
        public repBangKeCPNgoaiBH()
        {
            InitializeComponent();
        }
        public void BindingData(){
            ...
            colSoLuong.DataBindings.Add("Text", DataSource, "SoLuong").FormatString = "{0:0,0}";
