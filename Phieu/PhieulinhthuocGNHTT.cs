...
{
    public partial class PhieulinhthuocGNHTT : DevExpress.XtraReports.UI.XtraReport
    {
        public PhieulinhthuocGNHTT()
        {
            InitializeComponent();
        }
        string _tenRG = "";
        ...
        private void Detail_BeforePrint(object sender, CancelEventArgs e)
        {
            if (DungChung.Bien.MaBV != "24009")
            {
                ...
                if (GetCurrentColumnValue("SoLuong") != null && GetCurrentColumnValue("SoLuong").ToString() != "")
                {
                    ...
                    {
                        if (DungChung.Bien.MaBV == "30004" || DungChung.Bien.MaBV == "24012")
                        {
                            string soluongso = "";
