...
{
    public partial class rep_PhieuKCBNgoaiT : DevExpress.XtraReports.UI.XtraReport
    {
        public rep_PhieuKCBNgoaiT()
        {
            InitializeComponent();
        }
        List<ChiDinh> _lcd = new List<ChiDinh>();
        public rep_PhieuKCBNgoaiT(List<ChiDinh> _l)
        {
            InitializeComponent();
            _lcd = _l;
        }
        ...
        private void ReportHeader_BeforePrint(object sender, CancelEventArgs e)
        {
            ...
            //}
            txtTenCQ.Text = xrLabel16.Text = DungChung.Bien.TenCQ;
        ...
        private void ReportFooter_BeforePrint(object sender, CancelEventArgs e)
        {
            ...
            if (DungChung.Bien.MaBV == "04011") {
                colNguoiPhat_kt.Text = DungChung.Bien.KeToanVP;
