...
{
    public partial class Rep_PhieuXNHoaSinhMau_VX02 : DevExpress.XtraReports.UI.XtraReport
    {
        public Rep_PhieuXNHoaSinhMau_VX02()
        {
            InitializeComponent();
        }
        ...
        {
            string _mabsck = MaBSCK.Value.ToString();
        ...
        private void colBSCD_BeforePrint(object sender, CancelEventArgs e)
        {
