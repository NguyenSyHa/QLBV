...
{
    public partial class Rep_PhieuNoiSoi_TKA5 : DevExpress.XtraReports.UI.XtraReport
    {
        public Rep_PhieuNoiSoi_TKA5()
        {
            InitializeComponent();
        }
        ...
        private void ReportFooter_BeforePrint(object sender, CancelEventArgs e)
        {
            ...
            string macb = "";
            if (this.BSCD.Value != null)
                macb = BSCD.Value.ToString();
