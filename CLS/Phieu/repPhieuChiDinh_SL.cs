...
{
    public partial class repPhieuChiDinh_SL : DevExpress.XtraReports.UI.XtraReport
    {
        public repPhieuChiDinh_SL()
        {
            InitializeComponent();
        }
        bool HienThiGH = false;
        public repPhieuChiDinh_SL(bool hienthi)
        {
            InitializeComponent();
            HienThiGH = hienthi;
        }
        ...
        private void ReportHeader_BeforePrint_1(object sender, CancelEventArgs e)
        {
            ...
            if (DungChung.Bien.MaBV == "01071" || DungChung.Bien.MaBV == "01049" || DungChung.Bien.MaBV == "12345" || DungChung.Bien.MaBV == "56789")
                lab2.Visible = false;
            if (DungChung.Bien.MaBV == "27001" || DungChung.Bien.MaBV == "30010" || DungChung.Bien.MaBV == "12345" || DungChung.Bien.MaBV == "56789")
                dckp.Visible = true;
            if (DungChung.Bien.MaBV == "27001" || DungChung.Bien.MaBV == "27183" || DungChung.Bien.MaBV == "12345")
