...
namespace QLBV.FormThamSo
{
    public partial class frm_kqcls : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        private void frm_kqcls_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (DungChung.Bien.MaBV == "24012")
                {
                    ...
                    _lstatus.Add(new Status_CD { Ten = "Đã tiếp nhận", Status = 2 });
                ...
                if (DungChung.Bien.MaBV != "24012")
                {
                    colphuongphap.Visible = false;
                    colthoigian.Visible = false;
                }

                if (DungChung.Bien.MaBV == "30372")
                {
                    colMaMay.Visible = true;
                    colMaMay.VisibleIndex = 8;
                    colMaMay.OptionsColumn.AllowEdit = false;
                }
            }
            finally
            {
        ...
        private void TimKiem()
        {
            ...
            if (DungChung.Bien.MaBV == "30372")
            {
                strSQL = "sp_kqXN_TimKiem1";
            }
            else
            {
                strSQL = "sp_kqXN_TimKiem";
            }
        ...
        private void grvketqua_CellValueChanged(object sender, DevExpress.XtraGrid.Views.Base.CellValueChangedEventArgs e)
        {
            ...
            if (grvketqua.GetFocusedRowCellValue(colketqua) != null && !string.IsNullOrEmpty(grvketqua.GetFocusedRowCellValue(colketqua).ToString()))
                if (e.Column.Name == "colketqua")
                {
                    ...
                    else if (grvketqua.GetFocusedRowCellValue(colStatus_CD) != null && (grvketqua.GetFocusedRowCellValue(colStatus_CD).ToString() == "0" || grvketqua.GetFocusedRowCellValue(colStatus_CD).ToString() == "1"))
                    {
                        grvketqua.SetFocusedRowCellValue(colthoigian, DateTime.Now);
                    }
                }
            if (grvketqua.GetFocusedRowCellValue(colphuongphap) != null && !string.IsNullOrEmpty(grvketqua.GetFocusedRowCellValue(colphuongphap).ToString()))
            ...
            string phuongphap = grvketqua.GetFocusedRowCellDisplayText(colphuongphap);
            string thoigian = grvketqua.GetFocusedRowCellDisplayText(colthoigian);
            double kqd;
            float kqf;
            ...
            if (TenRG.First().TenRG.ToUpper().Contains("XN hóa sinh".ToUpper())) 
            {
                for (int i = 0; i < _tbCLSct.Rows.Count; i++)
                {
                    if (_tbCLSct.Rows[i]["madvct"].ToString() == _Madvxt)
                    {
                        ...
                        {
                            if (double.TryParse(ketqua, out kqd) || float.TryParse(ketqua, out kqf))
                            {
                                kqd = Math.Round(double.Parse(ketqua), 2);
                                _tbCLSct.Rows[i]["ketqua"] = kqd;
                            }
                        }

                        if (DungChung.Bien.MaBV == "24012")
                        {
                            _tbCLSct.Rows[i]["phuongphap"] = phuongphap;
                            _tbCLSct.Rows[i]["thoigian"] = thoigian;
                        }
                    }
                }
            }
        ...
        private void cboluu_Click(object sender, EventArgs e) // Chưa làm nút lưu. không được lưu khi chưa tạm thu
        {
            ...
            var bnhan = _Data.BenhNhans.Where(x=>x.MaBNhan == _int_maBN).FirstOrDefault();
            ...
            {
                bool Checktamthu = true;
                string erro = "";
                //var ChiDinh = _Data.ChiDinhs.Where(p => p.IdCLS == _IDCL).FirstOrDefault();
                var ChiDinh1 = _Data.ChiDinhs.Where(p => p.IdCLS == _IDCL).ToList();
                var _NgayCD12 = _Data.CLS.Where(p => p.IdCLS == _IDCL).FirstOrDefault();
                //if (bnhan.DTuong == "Dịch vụ")
                //{
                //    if (_NgayCD12.CapCuu == false)
                //    {
                ...
                if (ktra)
                {
                    ...
                    for (int i = 0; i < dataSource.Rows.Count; i++)
                    {
                        ...
                        if (DungChung.Bien.MaBV == "24012")
                        {
                            sua.PPXN_Quytrinhdo = dataSource.Rows[i]["phuongphap"].ToString();
                            sua.ThoiGian = Convert.ToDateTime(dataSource.Rows[i]["thoigian"].ToString());
                        }
            ...
            else
            {
                ...
                if (ktra)
                {
                    ...
                    for (int i = 0; i < _tbCLSct.Rows.Count; i++)
                    {
                        ...
                        else
                        {
                            if (DungChung.Bien.MaBV == "30004")
                            {
                                if ((_tbCLSct.Rows[i]["madvct"].ToString() == "HHCT2") || (_tbCLSct.Rows[i]["madvct"].ToString() == "tpt12"))
                                {
                                    if (Convert.ToDouble(_tbCLSct.Rows[i]["ketqua"].ToString()) < 70)
                                    {
                                        msg += _tbCLSct.Rows[i]["tenxn"].ToString() + "< 70 g/l; ";
                                        _stt = true;
                                    }
                                }
                                if ((_tbCLSct.Rows[i]["madvct"].ToString() == "HHCT9") || (_tbCLSct.Rows[i]["madvct"].ToString() == "tpt20"))
                                {
                                    if (Convert.ToDouble(_tbCLSct.Rows[i]["ketqua"].ToString()) < 150)
                                    {
                                        msg += _tbCLSct.Rows[i]["tenxn"].ToString() + "< 150 g/l; ";
                                        _stt = true;

                                    }
                                }
                                if ((_tbCLSct.Rows[i]["madvct"].ToString() == "tpt22"))
                                {
                                    if (Convert.ToDouble(_tbCLSct.Rows[i]["ketqua"].ToString()) < 2)
                                    {
                                        msg += _tbCLSct.Rows[i]["tenxn"].ToString() + "< 2 T/l; ";
                                        _stt = true;

                                    }
                                }
                                if ((_tbCLSct.Rows[i]["madvct"].ToString() == "SHCT6"))
                                {
                                    if (Convert.ToDouble(_tbCLSct.Rows[i]["ketqua"].ToString()) < 3)
                                    {
                                        msg += _tbCLSct.Rows[i]["tenxn"].ToString() + "< 3 mmol/l; ";
                                        _stt = true;
                    ...
                    if (_stt == true)
                    {
                        DialogResult dia1 = DialogResult.Yes;
                        dia1 = MessageBox.Show("Kết quả có chỉ số " + msg + " có giá trị ngoài giá trị trung bình, Bạn có muốn lưu?", "Hỏi lưu", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button2);
                        if (dia1 == DialogResult.No)
                        {
                            ktra = false;
                        }
                    }
                ...
                #endregion
                var cd = (from chidinh in _Data.ChiDinhs.Where(p => _lIDCD.Contains(p.IDCD)) select chidinh).ToList();
                Console.WriteLine("AAA: " + cd.Count());
                ...
                if (ktra)
                {
                    ...
                    for (int i = 0; i < _tbCLSct.Rows.Count; i++)
                    {
                        ...
                        if (DungChung.Bien.MaBV == "24012")
                        {
                            sua.PPXN_Quytrinhdo = _tbCLSct.Rows[i]["phuongphap"].ToString();
                            //sua.ThoiGian = Convert.ToDateTime(_tbCLSct.Rows[i]["thoigian"].ToString());
                        }
                    ...
                    foreach (var c in cd)
                    {
                        ...
                        if (LupCanBo.EditValue != null)
                        {
                            c.MaCBth = LupCanBo.EditValue.ToString();
                        }
                        else
                            c.MaCBth = "";
                        _Data.SaveChanges();
        ...
        private void simpleButton1_Click(object sender, EventArgs e)
        {
            ...
            if (GrvNhomDV.GetFocusedRowCellValue("IDCLS") != null && GrvNhomDV.GetFocusedRowCellValue("IDCLS").ToString() != "" && GrvNhomDV.GetFocusedRowCellValue("TenRG") != null)
            {
                ...
                else if (DungChung.Bien.MaBV == "30372")
                {
                    int _int_maBN = 0;
                    Int32.TryParse(txtMaBN.Text, out _int_maBN);
                    QLBV.FormThamSo.frm_InXnTongHop frm = new QLBV.FormThamSo.frm_InXnTongHop(_int_maBN, _lidcls);
                    frm.ShowDialog();
                }    
                //else if (DungChung.Bien.MaBV == "27777")
                //{
                ...
                {
                    QLBV.CLS.InPhieu._InPhieu_XetNghiem(_Data, TTN, String.IsNullOrEmpty(txtMaBN.Text) ? 0 : Convert.ToInt32(txtMaBN.Text), idcls, 0, null, null);
                }
            }
            ...
            if (GrvNhomDV.GetFocusedRowCellValue("IDCLS") != null && GrvNhomDV.GetFocusedRowCellValue("IDCLS").ToString() != "")
            {
                ...
                if (DungChung.Bien.MaBV == "27023")
                {
                    ...
                    if (_tbCLSct.Rows.Count > 0)
                    {
                        ...
                        {
                            _lIDCD.Add(Convert.ToInt32(row[0]));
                        }
                    }
                }
                else
                {
                    ...
                    if (_tbCLSct.Rows.Count > 0)
                    {
                        if (DungChung.Bien.MaBV == "30372")
                        {
                            ...
                            foreach (DataRow row in _tbCLSct.Rows)
                            {
                                if (row.ItemArray[5] != "" && row.ItemArray[5] != null)
                                {
                                    if (row.ItemArray[9] != "" && row.ItemArray[9] != null)
                                    {
                                        string b = row.ItemArray[9].ToString();
                                        if (b == "hh06.01" || b == "hh06.02" || b == "hh06.04" || b == "hh06.06" || b == "hh06.08" || b == "hh06.10" || b == "hh06.12" || b == "hh06.24")
                                        {
                                            int i = Convert.ToInt32(row.ItemArray[8]);
                                            var cls = _Data.CLScts.Where(p => p.Id == i).ToList();
                                            if (cls.Count > 0)
                                            {
                                                if (cls.First().KetQua != "" && cls.First().KetQua != null)
                                                {
                                                    string c = cls.First().KetQua.ToString();
                                                    string[] d = c.Split('.');
                                                    if (d.Length == 2)
                                                    {
                                                        if (d[1].Length == 1)
                                                        {
                                                            string str = d[1];
                                                            d[1] = str + "0".ToString();
                                                            cls.First().KetQua = d[0] + "." + d[1];
                                                        }
                                                    }
                                                    else if (d.Length == 1)
                                                    {
                                                        cls.First().KetQua = d[0] + ".00";
                                                    }
                                                }
                                            }
                                        }
                                        if (b == "hh06.03" || b == "hh06.05" || b == "hh06.07" || b == "hh06.09" || b == "hh06.11" || b == "hh06.14" || b == "hh06.15" || b == "hh06.16" || b == "hh06.18" || b == "hh06.19" || b == "hh06.22" || b == "hh06.23")
                                        {
                                            int i = Convert.ToInt32(row.ItemArray[8]);
                                            var cls = _Data.CLScts.Where(p => p.Id == i).ToList();
                                            if (cls.Count > 0)
                                            {
                                                if (cls.First().KetQua != "" && cls.First().KetQua != null)
                                                {
                                                    ...
                                                    if (d.Length == 1)
                                                    {
                                                        cls.First().KetQua = d[0] + ".0";
                                                    }
                                                }
                                            }
                                        }
                                    }
                                    string a = row.ItemArray[5].ToString();
                                    if (a.Contains("Tỷ Trọng"))
                                    {
                                        int i = Convert.ToInt32(row.ItemArray[8]);
                                        var cls = _Data.CLScts.Where(p => p.Id == i).ToList();
                                        if (cls.Count > 0)
                                        {
                                            if (cls.First().KetQua != "" && cls.First().KetQua != null)
                                            {
                                                string b = cls.First().KetQua.ToString();
                                                string[] d = b.Split('.');
                                                if (d.Length == 2)
                                                {
                                                    if (d[1].Length < 3)
                                    ...
                                    if (a.Contains("PH"))
                                    {
                                        ...
                                        if (cls.Count > 0)
                                        {
                                            if (cls.First().KetQua != "" && cls.First().KetQua != null)
                                            {
                                                ...
                                                if (b.Length == 1)
                                                {
                                                    b = b.ToString() + ".0".ToString();
                                                    cls.First().KetQua = b;
                                                }
                                            }
                                        }
                                    }
                                    if (a.Contains("Urobilinogen"))
                                    {
                                        int i = Convert.ToInt32(row.ItemArray[8]);
                                        var cls = _Data.CLScts.Where(p => p.Id == i).ToList();
                                        if (cls.Count > 0)
                                    ...
                                    if (a.Contains("Thể cetonic"))
                                    {
                                        int i = Convert.ToInt32(row.ItemArray[8]);
                                        var cls = _Data.CLScts.Where(p => p.Id == i).ToList();
                                        if (cls.Count > 0)
                                        {
                                            if (cls.First().KetQua == "15")
                                            {
                                                cls.First().KetQua = "1+";
                                            }
                                            if (cls.First().KetQua == "40")
                                            {
                                                cls.First().KetQua = "2+";
                                            }
                                            if (cls.First().KetQua == "80")
                                            {
                                                cls.First().KetQua = "3+";
                                            }
                                        }
                                    }
                                    if (a.Contains("Protein"))
                                    {
                                        int i = Convert.ToInt32(row.ItemArray[8]);
                                        var cls = _Data.CLScts.Where(p => p.Id == i).ToList();
                                        if (cls.Count > 0)
                                        {
                                            if (cls.First().KetQua == "30")
                                            {
                                                cls.First().KetQua = "1+";
                                            }
                                            if (cls.First().KetQua == "100")
                                            {
                                                cls.First().KetQua = "2+";
                                            }
                                            if (cls.First().KetQua == "300")
                                            {
                                                cls.First().KetQua = "3+";
                                            }
                                        }
                                ...
                                if (row.ItemArray[7] != "" && row.ItemArray[7] != null)
                                {
                                    string a = row.ItemArray[7].ToString();
                                    if (a.Contains("Negative"))
                                    {
                                        row.ItemArray[7] = "Âm tính";
                                        int i = Convert.ToInt32(row.ItemArray[8]);
                                        var cls = _Data.CLScts.Where(p => p.Id == i).ToList();
                                        if (cls.Count > 0)
                                        {
                                            cls.First().KetQua = "Âm tính";
                                        }
                                    }
                                    if (a.Contains("Positive"))
                                    {
                                        row.ItemArray[7] = "Dương tính";
                                        int i = Convert.ToInt32(row.ItemArray[8]);
                                        var cls = _Data.CLScts.Where(p => p.Id == i).ToList();
                                        if (cls.Count > 0)
                                        {
                                            cls.First().KetQua = "Dương tính";
                                        }
                                    }
                                    if (a.Contains("Trace"))
                                    {
                    ...
                    if (_tbCLSct.Rows.Count > 0)
                    {
                        if(DungChung.Bien.MaBV == "24272") 
                        {
                            for (int i = 0; i < _tbCLSct.Rows.Count; i++)
                            //{
                            //} (DataRow row in _tbCLSct.Rows)
                            {
                                if (_tbCLSct.Rows[i].ItemArray[5] != null && _tbCLSct.Rows[i].ItemArray[5].ToString() != "" && _tbCLSct.Rows[i].ItemArray[5].ToString().Contains("|"))
                                {
                                    int _int_maBN = 0;
                                    if (!string.IsNullOrEmpty(txtMaBN.Text))
                                    {
                                    ...
                                    var bn = _Data.BenhNhans.FirstOrDefault(p => p.MaBNhan == _int_maBN);

                                    var tsbt = _tbCLSct.Rows[i].ItemArray[5].ToString().Split('|');

                                    if (bn != null)
                                    {
                                        if (bn.GTinh == 1)// nam
                                        {
                                            _tbCLSct.Rows[i].SetField(5, tsbt[0]);
                                        }
                                        else
                                        {
                                            _tbCLSct.Rows[i].SetField(5, tsbt[1]); //nu
                                        }
                                    }
                                }
                            }
                            ...
                            if (_tbCLSct.Rows.Count > 0 && !string.IsNullOrEmpty(_tbCLSct.Rows[0]["Status"].ToString()) && Convert.ToInt32(_tbCLSct.Rows[0]["Status"].ToString()) == 0)
                            {
                                for (int i = 0; i < grvketqua.RowCount; i++)
                                {
                                    ...
                                    if (grvketqua.GetRowCellValue(i, MaDVct) != null && grvketqua.GetRowCellValue(i, MaDVct).ToString() != "")
                                    {
                                        ...
                                        var pp = _Data.CLScts.Where(p => p.MaDVct == madvct).ToList();
                ...
                if (GrvNhomDV.GetFocusedRowCellValue("TenRG") != null)
                {
                    ...
                    string stt = GrvNhomDV.GetFocusedRowCellValue("Status").ToString();
                    if (stt != "1")
                    {
                        EnableControl(true);
                    }
        ...
        private void sbtSua_Click(object sender, EventArgs e)
        {
            ...
            if (DungChung.Bien.MaBV == "24012")
            {
                var trangthai = (from cls in _Data.CLS.Where(p => p.MaBNhan == _Mabn)
                                 join cd in _Data.ChiDinhs on cls.IdCLS equals cd.IdCLS
                                 select new { cd.Status }).ToList();
                if (trangthai.First().Status == 2)
                {
                    MessageBox.Show("Bệnh nhân đã tiếp nhận không thể sửa!");
                    return;
                }
            }
            if (DungChung.Bien.MaBV == "30372" && q.Count > 0)
        ...
        private void sbtXoa_Click(object sender, EventArgs e)
        {
            ...
            if (DungChung.Bien.MaBV == "24012")
            {
                ...
                if (trangthai.First().Status == 2)
                {
                    MessageBox.Show("Bệnh nhân đã tiếp nhận không thể xoá!");
                    return;
                }
            }
            if (KT.Count > 0)
        ...
        private void btnKhopMa_Click(object sender, EventArgs e)
        {
            ...
            if ((DungChung.Bien.MaBV == "01071" || DungChung.Bien.MaBV == "01049") ? true : !string.IsNullOrEmpty(txtBarcode.Text))
            {
                if (barcode == "")
                {
                    barcode = null;
        ...
        private void btnInTem_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                foreach (var item in updateSID)
                {
                    ...
                    item.Barcode_Time = DateTime.Now;
                }
                _Data.SaveChanges();
                bool ok = true;
            ...
            else if (cboPhieu.SelectedIndex == 4)
            {
                try
                {
                    ...
                    if (query.Count > 0)
                    {
                        ...
                        {
                            QLBV.CLS.InPhieu._InPhieu_XetNghiem(_Data, item.TenRG, String.IsNullOrEmpty(txtMaBN.Text) ? 0 : Convert.ToInt32(txtMaBN.Text), item.IdCLS, 0, null, null);
                        }
                    }
                    else
        ...
        private void repositoryItemCheckEdit1_CheckedChanged(object sender, EventArgs e)
        {
            ...
            if (row != null)
            {
                ...
                int idcls = Convert.ToInt32(idCLSct);
                if (listCheckClsct.Contains(idCLSct))/*(o => o == idCLSct))*/
                {
                    listCheckClsct.Remove(idCLSct);
                    _lidcls.Remove(idcls);
                }
                else
                {
        ...
        private void cboketqua_MouseDown(object sender, MouseEventArgs e)
        {
            if (DungChung.Bien.MaBV == "27023")
            {
                //btnInPhieu.Enabled = false;
        ...
        private void cboketqua_MouseLeave(object sender, EventArgs e)
        {
            if (DungChung.Bien.MaBV == "27023")
            {
                //btnInPhieu.Enabled = false;
