...
{
    public partial class repBcNXT_CK_01830 : DevExpress.XtraReports.UI.XtraReport
    {
        public repBcNXT_CK_01830()
        {
            InitializeComponent();
        }
        bool hiennhom = true;
        bool HTTrongNgoaiNuoc = false;
        public repBcNXT_CK_01830(bool a, bool HTTrongNgoaiNuoc)
        {
            InitializeComponent();
            hiennhom = a;
