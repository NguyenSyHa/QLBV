...
{
    public partial class Rep_BcSuDungThuoc_TDuong : DevExpress.XtraReports.UI.XtraReport
    {
        public Rep_BcSuDungThuoc_TDuong()
        {
            InitializeComponent();
        }
        //bool HThi = true;
        ...
        public void BindingData()
        {
            ...
            col1SL.DataBindings.Add("Text", DataSource, "TNhapTKSL").FormatString = DungChung.Bien.FormatString[1];
            col1TT.DataBindings.Add("Text", DataSource, "TNhapTKTT").FormatString = DungChung.Bien.FormatString[1];
            col1TTCong.DataBindings.Add("Text", DataSource, "TNhapTKTT").FormatString = DungChung.Bien.FormatString[1];
            col1TTtc.DataBindings.Add("Text", DataSource, "TNhapTKTT").FormatString = DungChung.Bien.FormatString[1];

            col2SL.DataBindings.Add("Text", DataSource, "XuatBHSL").FormatString = DungChung.Bien.FormatString[1];
            col2TT.DataBindings.Add("Text", DataSource, "XuatBHTT").FormatString = DungChung.Bien.FormatString[1];
            col2TTcong.DataBindings.Add("Text", DataSource, "XuatBHTT").FormatString = DungChung.Bien.FormatString[1];
            col2TTtc.DataBindings.Add("Text", DataSource, "XuatBHTT").FormatString = DungChung.Bien.FormatString[1];

            col3SL.DataBindings.Add("Text", DataSource, "Xuat139SL").FormatString = DungChung.Bien.FormatString[1];
            col3TT.DataBindings.Add("Text", DataSource, "Xuat139TT").FormatString = DungChung.Bien.FormatString[1];
            col3TTcong.DataBindings.Add("Text", DataSource, "Xuat139TT").FormatString = DungChung.Bien.FormatString[1];
            col3TTtc.DataBindings.Add("Text", DataSource, "Xuat139TT").FormatString = DungChung.Bien.FormatString[1];

            col4SL.DataBindings.Add("Text", DataSource, "XuatTESL").FormatString = DungChung.Bien.FormatString[1];
            col4TT.DataBindings.Add("Text", DataSource, "XuatTETT").FormatString = DungChung.Bien.FormatString[1];
            col4TTcong.DataBindings.Add("Text", DataSource, "XuatTETT").FormatString = DungChung.Bien.FormatString[1];
            col4TTtc.DataBindings.Add("Text", DataSource, "XuatTETT").FormatString = DungChung.Bien.FormatString[1];

            col5SL.DataBindings.Add("Text", DataSource, "XuatLCSL").FormatString = DungChung.Bien.FormatString[1];
            col5TT.DataBindings.Add("Text", DataSource, "XuatLCTT").FormatString = DungChung.Bien.FormatString[1];
            col5TTcong.DataBindings.Add("Text", DataSource, "XuatLCTT").FormatString = DungChung.Bien.FormatString[1];
            col5TTtc.DataBindings.Add("Text", DataSource, "XuatLCTT").FormatString = DungChung.Bien.FormatString[1];
