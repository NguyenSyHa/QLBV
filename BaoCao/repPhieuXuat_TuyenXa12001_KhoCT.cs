...
{
    public partial class repPhieuXuat_TuyenXa12001_KhoCT : DevExpress.XtraReports.UI.XtraReport
    {
        public repPhieuXuat_TuyenXa12001_KhoCT()
        {
            InitializeComponent();
        }
        public void BindingData()
        {
            ...
            celNoiSX.DataBindings.Add("Text", DataSource, "NhaSX");
            ...
            celSL.DataBindings.Add("Text", DataSource, "SoLuongX").FormatString = DungChung.Bien.FormatString[0];
