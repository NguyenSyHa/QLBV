...
{
    public partial class repBbKKHoaChat : DevExpress.XtraReports.UI.XtraReport
    {
        bool _Thang = true;
        public repBbKKHoaChat(bool Thang)
        {
            InitializeComponent(); _Thang = Thang;
        }
        public void BindingData()
        {
            ...
            colTenHoaChatGh2.DataBindings.Add("Text", DataSource, "TenTieuNhom");
