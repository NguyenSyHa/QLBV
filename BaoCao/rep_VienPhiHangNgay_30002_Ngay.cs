...
{
    public partial class rep_VienPhiHangNgay_30002_Ngay : DevExpress.XtraReports.UI.XtraReport
    {
        private bool HienThi = false;//= true: chỉ hiển thị viện phí theo ngày

        public rep_VienPhiHangNgay_30002_Ngay()
        {
            InitializeComponent();
        }

        public rep_VienPhiHangNgay_30002_Ngay(bool hienthi)
        {
