...
{
    public partial class Rep_80aTH_1399_CongKham : DevExpress.XtraReports.UI.XtraReport
    {
        List<DTuong> _ldtuong = new List<DTuong>();
        public bool HtTuyen = true;
        int _a = 0;
        public Rep_80aTH_1399_CongKham(int a)
        {
            InitializeComponent();
        ...
        public void BindingData(int a)
        {
            ...
            colTienGiuongRF.DataBindings.Add("Text", DataSource, "T_giuong").FormatString = DungChung.Bien.FormatString[1];

            colTienCKGF1.DataBindings.Add("Text", DataSource, "T_kham").FormatString = DungChung.Bien.FormatString[1];
            colTienCKGF2.DataBindings.Add("Text", DataSource, "T_kham").FormatString = DungChung.Bien.FormatString[1];
            colTienCKRF.DataBindings.Add("Text", DataSource, "T_kham").FormatString = DungChung.Bien.FormatString[1];
