...
{
    public partial class rep_BkeVienPhi_InMaThe_26007 : DevExpress.XtraReports.UI.XtraReport
    {
        public static DateTime tungay;
        public static DateTime denngay;
        QLBV_Database.QLBVEntities data;
        public rep_BkeVienPhi_InMaThe_26007()
        {
            InitializeComponent();
        ...
        internal void BindingData()
        {
            ...
            contongtn20.DataBindings.Add("Text", DataSource, "tn20").FormatString = DungChung.Bien.FormatString[1];
