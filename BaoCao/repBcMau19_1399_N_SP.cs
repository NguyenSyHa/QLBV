...
{
    public partial class repBcMau19_1399_N_SP : DevExpress.XtraReports.UI.XtraReport
    {
        public repBcMau19_1399_N_SP()
        {
            InitializeComponent();
        }
        bool inTieuNhom = false;
        public repBcMau19_1399_N_SP(bool inTN)
        {
            InitializeComponent();
            inTieuNhom = inTN;
        }
        public void BindingData()
        {
            ...
            colGiaMua.DataBindings.Add("Text", DataSource, "DonGia").FormatString = DungChung.Bien.FormatString[1];
