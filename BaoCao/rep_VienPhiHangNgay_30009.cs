...
{
    public partial class rep_VienPhiHangNgay_30009 : DevExpress.XtraReports.UI.XtraReport
    {
        private bool _hienthi = false;

        public rep_VienPhiHangNgay_30009()
        {
            InitializeComponent();
        }

        public rep_VienPhiHangNgay_30009(bool hienthi)
        {
