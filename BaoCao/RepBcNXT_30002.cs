...
{
    public partial class RepBcNXT_30002 : DevExpress.XtraReports.UI.XtraReport
    {
        public RepBcNXT_30002()
        {
            InitializeComponent();
        }
        bool _ht = true;
        ...
        int ma = -1;
        public RepBcNXT_30002(bool ht, bool nk, int aa)
        {
            InitializeComponent();
            _ht = ht;
            HTTrongNgoaiNuoc = nk;
        ...
        public void BindingData()
        {
            ...
            {
                colNhapCKSL.DataBindings.Add("Text", DataSource, "NhapKhac_SL").FormatString = DungChung.Bien.FormatString[0];
                colNhapCKTTde.DataBindings.Add("Text", DataSource, "NhapKhac_TT").FormatString = DungChung.Bien.FormatString[1];
                colNhapCKTTTong.DataBindings.Add("Text", DataSource, "NhapKhac_TT").FormatString = DungChung.Bien.FormatString[1];
                colNhapCKTTGf1.DataBindings.Add("Text", DataSource, "NhapKhac_TT").FormatString = DungChung.Bien.FormatString[1];
                colNhapCKTTGf2.DataBindings.Add("Text", DataSource, "NhapKhac_TT").FormatString = DungChung.Bien.FormatString[1];
                colNhapCKTTGf3.DataBindings.Add("Text", DataSource, "NhapKhac_TT").FormatString = DungChung.Bien.FormatString[1];
