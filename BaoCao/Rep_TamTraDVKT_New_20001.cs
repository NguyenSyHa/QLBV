...
{
    public partial class Rep_TamTraDVKT_New_20001 : DevExpress.XtraReports.UI.XtraReport
    {
        public Rep_TamTraDVKT_New_20001()
        {
            InitializeComponent();
        }
        List<FormThamSo.Frm_TamTraDVKT_New.c_DSThuoc> _lDichVu = new List<FormThamSo.Frm_TamTraDVKT_New.c_DSThuoc>();
        List<FormThamSo.Frm_TamTraDVKT_New.c_BN_Thuoc> _lSoLuong = new List<FormThamSo.Frm_TamTraDVKT_New.c_BN_Thuoc>();
        public Rep_TamTraDVKT_New_20001(List<FormThamSo.Frm_TamTraDVKT_New.c_DSThuoc> lDichVu, List<FormThamSo.Frm_TamTraDVKT_New.c_BN_Thuoc> lSoLuong)
        {
            InitializeComponent();
        ...
        public void BindingData()
        {
            ...
            colcaotuoi.DataBindings.Add("Text", DataSource, "Caotuoi");
