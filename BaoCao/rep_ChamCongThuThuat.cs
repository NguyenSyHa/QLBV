...
{
    public partial class rep_ChamCongThuThuat : DevExpress.XtraReports.UI.XtraReport
    {
        public rep_ChamCongThuThuat()
        {
            InitializeComponent();
        }
