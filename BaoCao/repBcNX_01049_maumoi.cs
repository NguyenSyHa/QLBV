...
{
    public partial class repBcNX_01049_maumoi : DevExpress.XtraReports.UI.XtraReport
    {
        public repBcNX_01049_maumoi()
        {
            InitializeComponent();
        }
        public void BindingData()
        {
            ...
            colXuatBHSL.DataBindings.Add("Text", DataSource, "Xuatnoitru1").FormatString = DungChung.Bien.FormatString[0];
            colXuatBHSL1.DataBindings.Add("Text", DataSource, "Xuatnoitru2").FormatString = DungChung.Bien.FormatString[0];
