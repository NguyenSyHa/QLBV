...
{
    public partial class Rep_BcHoatDongPTTT_TH02 : DevExpress.XtraReports.UI.XtraReport
    {
        public Rep_BcHoatDongPTTT_TH02()
        {
            InitializeComponent();
        }
        public void BindingData()
        {
            ...
            col4.DataBindings.Add("Text", DataSource, "BHYT").FormatString = "{0:##,###}";
            col5.DataBindings.Add("Text", DataSource, "TP").FormatString = "{0:##,###}";
            col6.DataBindings.Add("Text", DataSource, "NoiTru").FormatString = "{0:##,###}";
            col7.DataBindings.Add("Text", DataSource, "NgoaiTru").FormatString = "{0:##,###}";
            ...
            col4T.DataBindings.Add("Text", DataSource, "BHYT").FormatString = "{0:##,###}";
            col5T.DataBindings.Add("Text", DataSource, "TP").FormatString = "{0:##,###}";
            col6T.DataBindings.Add("Text", DataSource, "NoiTru").FormatString = "{0:##,###}";
            col7T.DataBindings.Add("Text", DataSource, "NgoaiTru").FormatString = "{0:##,###}";
