...
{
    public partial class repBangKe01bv_A4 : DevExpress.XtraReports.UI.XtraReport
    {
        public repBangKe01bv_A4()
        {
            InitializeComponent();
        }
        ...
        private void ReportFooter_BeforePrint(object sender, CancelEventArgs e)
        {
            ...
            //GDBH.Value = DungChung.Bien.MaBV == "30340" ? DungChung.Bien.GiamDinhBH : "";
            ...
            else
            {
                txtTT.Text = "- Tổng chi phí đợt điều trị: " + DungChung.Ham.DocTienBangChu(Convert.ToDouble(Tongtien.Value), " đồng.");
                txtTienBN.Text = "- Số tiền người bệnh trả: " + DungChung.Ham.DocTienBangChu(Convert.ToDouble(TienBN.Value), " đồng.")+"\nTrong đó:";
                txtbnctt.Text = "  + Số tiền người bệnh cùng chi trả: " + DungChung.Ham.DocTienBangChu(Convert.ToDouble(TienBNctt.Value), " đồng.");
                txtbntt.Text = "  + Số tiền người bệnh tự trả: " + DungChung.Ham.DocTienBangChu(Convert.ToDouble(TienBNtt.Value), " đồng.");
                txtnguonkhac.Text = "- Nguồn khác:";
                txtTienBH.Text = "- Số tiền quỹ BHYT thanh toán: " + DungChung.Ham.DocTienBangChu(Convert.ToDouble(TienBH.Value), " đồng.");
            }
