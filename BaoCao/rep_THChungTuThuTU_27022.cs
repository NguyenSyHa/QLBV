...
{
    public partial class rep_THChungTuThuTU_27022 : DevExpress.XtraReports.UI.XtraReport
    {
        public rep_THChungTuThuTU_27022()
        {
            InitializeComponent();
        }
        ...
        {
            celQuyenCT.DataBindings.Add("Text", DataSource, "QuyenHD");
