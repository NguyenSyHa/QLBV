...
{
    public partial class Rep_TongHop_XN_Mau_4069_2 : DevExpress.XtraReports.UI.XtraReport
    {
        public Rep_TongHop_XN_Mau_4069_2()
        {
            InitializeComponent();
        }
        ...
        public Rep_TongHop_XN_Mau_4069_2(List<FormThamSo.Frm_TongHop_CLS.c_DSDV> lDichVu, List<FormThamSo.Frm_TongHop_CLS.BenhNhan> lSoLuongt)
        {
            InitializeComponent();
        ...
        public void BindingData()
        {
                ...
                #endregion
                int i = 30;
                //for (int i = 30; i <= _lDichVu.Count;i++ )
                //{
