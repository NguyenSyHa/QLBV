...
{
    public partial class Rep_79a_HD_1399_Tyle : DevExpress.XtraReports.UI.XtraReport
    {
      public  bool HtTuyen = true;
      public bool HtMaICD = false;
      int _a = 0;
        List<DTuong> _ldtuong = new List<DTuong>();
        public Rep_79a_HD_1399_Tyle(int a)
        {
            InitializeComponent();
            ...
            {
                xrTableCell35.Summary.Running = SummaryRunning.None;
                xrTableCell74.Summary.Running = SummaryRunning.None;
                xrTableCell36.Summary.Running = SummaryRunning.None;
            }
        }
