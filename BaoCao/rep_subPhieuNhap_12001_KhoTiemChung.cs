...
{
    public partial class rep_subPhieuNhap_12001_KhoTiemChung : DevExpress.XtraReports.UI.XtraReport
    {
        public rep_subPhieuNhap_12001_KhoTiemChung()
        {
            InitializeComponent();
        }
        public void BindingData()
        {
            ...
            colnoisx.DataBindings.Add("Text", DataSource, "HangSX");
