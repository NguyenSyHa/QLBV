...
{
    public partial class Rep_SoPhauThuat_ThuThuat_A4_SL : DevExpress.XtraReports.UI.XtraReport
    {
        public Rep_SoPhauThuat_ThuThuat_A4_SL()
        {
            InitializeComponent();
        }
