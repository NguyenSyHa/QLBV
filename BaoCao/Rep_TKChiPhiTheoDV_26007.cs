...
{
    public partial class Rep_TKChiPhiTheoDV_26007 : DevExpress.XtraReports.UI.XtraReport
    {
        public Rep_TKChiPhiTheoDV_26007()
        {
            InitializeComponent();
            //_lds = ds;
        }
        ...
        public void BindingData()
        {
            ...
            celTienBNT.DataBindings.Add("Text", DataSource, "TienBN");
            celTienBNT.Summary.FormatString = DungChung.Bien.FormatString[1];
            celTienBHT.DataBindings.Add("Text", DataSource, "TienBH");
            celTienBHT.Summary.FormatString = DungChung.Bien.FormatString[1];
        }
        //int tdk = 0;
