...
{
    public partial class Rep_BcNXTTuTruc : DevExpress.XtraReports.UI.XtraReport
    {
        private bool hienthi = false;

        public Rep_BcNXTTuTruc()
        {
            InitializeComponent();
        }

        public Rep_BcNXTTuTruc(bool p)
        {
        ...
        public void BindingData()
        {
                ...
                MaDV.DataBindings.Add("Text", DataSource, "MaDV");
                ...
                TonDKSL.DataBindings.Add("Text", DataSource, "sltondk").FormatString = DungChung.Bien.FormatString[1];
                TonDKTT.DataBindings.Add("Text", DataSource, "tttondk").FormatString = DungChung.Bien.FormatString[1];
                colTonDKTTTong.DataBindings.Add("Text", DataSource, "tttondk").FormatString = DungChung.Bien.FormatString[1];

                NhapTKSL.DataBindings.Add("Text", DataSource, "slnhap").FormatString = DungChung.Bien.FormatString[1];
                NhapTKTT.DataBindings.Add("Text", DataSource, "ttnhap").FormatString = DungChung.Bien.FormatString[1];
                colNhapTKTTTong.DataBindings.Add("Text", DataSource, "ttnhap").FormatString = DungChung.Bien.FormatString[1];

                XuatTKSL.DataBindings.Add("Text", DataSource, "slxuat").FormatString = DungChung.Bien.FormatString[1];
                XuatTKTT.DataBindings.Add("Text", DataSource, "ttxuat").FormatString = DungChung.Bien.FormatString[1];
                colXTKTTTong.DataBindings.Add("Text", DataSource, "ttxuat").FormatString = DungChung.Bien.FormatString[1];

                TonCKSL.DataBindings.Add("Text", DataSource, "sltonck").FormatString = DungChung.Bien.FormatString[1];
                TonCKTT.DataBindings.Add("Text", DataSource, "tttonck").FormatString = DungChung.Bien.FormatString[1];
                colTonCKTTTong.DataBindings.Add("Text", DataSource, "tttonck").FormatString = DungChung.Bien.FormatString[1];
        ...
        private void Rep_BcNXTTuTruc_BeforePrint(object sender, CancelEventArgs e)
        {
