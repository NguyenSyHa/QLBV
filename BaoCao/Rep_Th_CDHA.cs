...
{
    public partial class Rep_Th_CDHA : DevExpress.XtraReports.UI.XtraReport
    {
        public Rep_Th_CDHA()
        {
            InitializeComponent();
        ...
        public Rep_Th_CDHA(List<FormThamSo.Frm_TongHop_CLS.c_DSDV> lDichVu, List<FormThamSo.Frm_TongHop_CLS.BenhNhan> lSoLuongt)
        {
            InitializeComponent();
