...
{
    public partial class Rep_PhieuNS_Co_Tu_Cung_12345 : DevExpress.XtraReports.UI.XtraReport
    {
        public Rep_PhieuNS_Co_Tu_Cung_12345()
        {
            InitializeComponent();
        }
        ...
        private void ReportHeader_BeforePrint(object sender, CancelEventArgs e)
        {
            ...
            txtSoYT.Text = txtSoYT2.Text = "Điện thoại: " + DungChung.Bien.SDTCQ;
            txtTenBV1.Text = txtTenBV2.Text = DungChung.Bien.TenCQ.ToUpper();
            txtdchi.Text = txtdchi2.Text = "Địa chỉ: " + DungChung.Bien.DiaChi;
            logo24272.Image = DungChung.Ham.GetLogo();
                ...
                for (int i = 0; i < arrDuongDan.Length; i++)
                {
                    switch (i)
                    {
                        ...
                        case 2:
                            ...
                            this.picNoiSoi3.ImageUrl = arrDuongDan[2];
                            break;
                        case 3:
                            if (!string.IsNullOrEmpty(arrDuongDan[3]))
                                dem++;
                            this.picNoiSoi4.ImageUrl = arrDuongDan[3];
