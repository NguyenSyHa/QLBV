...
{
    public partial class rep_PhieuXuatNgoaiBV_30003 : DevExpress.XtraReports.UI.XtraReport
    {
        public rep_PhieuXuatNgoaiBV_30003()
        {
            InitializeComponent();
        }
        public void BindingData()
        {
            ...
            celNgayQD.DataBindings.Add("Text", DataSource, "NgayQD").FormatString = "{0:dd/MM/yyyy}";
