...
{
    public partial class Rep_SoVaoRaChuyenVien_ThemCot : DevExpress.XtraReports.UI.XtraReport
    {
        public Rep_SoVaoRaChuyenVien_ThemCot()
        {
            InitializeComponent();
        }
        ...
        public void BindingData()
        {
          ...
          //  xrLabel12.DataBindings.Add("Text",DataSource,"MaBNhan");
            ...
            celKhoaVV.DataBindings.Add("Text", DataSource, "KPChuyen");
