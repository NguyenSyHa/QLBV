...
{
    public partial class PhieulinhthuocGNHTT_27023 : DevExpress.XtraReports.UI.XtraReport
    {
        public PhieulinhthuocGNHTT_27023()
        {
            InitializeComponent();
        }
        string _tenRG = "";
        ...
        public void BindingData()
        {
            ...
            collSoLo.DataBindings.Add("Text", DataSource, "SoLo");
            clHanDung.DataBindings.Add("Text", DataSource, "HanDung").FormatString = "{0: dd/MM/yyyy}";
            ...
            if (DungChung.Bien.MaBV != "24009")
            {
                ...
                if (GetCurrentColumnValue("SoLuong") != null && GetCurrentColumnValue("SoLuong").ToString() != "")
                {
                    ...
                    if (DungChung.Bien.MaBV == "30004")
                    {
                        ...
                        var gc = (from dt in _data.DThuocs
