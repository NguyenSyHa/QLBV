...
{
    public partial class RepBcNXT_HH_01830 : DevExpress.XtraReports.UI.XtraReport
    {
        public RepBcNXT_HH_01830()
        {
            InitializeComponent();
        }
        bool _ht = true;
        bool HTTrongNgoaiNuoc = false;
        public RepBcNXT_HH_01830(bool ht, bool HTTrongNgoaiNuoc)
        {
            InitializeComponent();
            _ht = ht;
