...
{
    public partial class Rep_BcTinhHinhBenhTatICD10_04002 : DevExpress.XtraReports.UI.XtraReport
    {
        public Rep_BcTinhHinhBenhTatICD10_04002()
        {
            InitializeComponent();
        }
        public void BindingData()
        {
            ...
            colSoNgayDT_6.DataBindings.Add("Text", DataSource, "SoNgaydt6");
            colSoNgayDT_TS.DataBindings.Add("Text", DataSource, "SoNgaydtTS");
            ...
            colSoNgayDT_6t.DataBindings.Add("Text", DataSource, "SoNgaydt6");
            colSoNgayDT_TSt.DataBindings.Add("Text", DataSource, "SoNgaydtTS");
            ...
            c13t.DataBindings.Add("Text", DataSource, "SoNgaydtTS");
            c14t.DataBindings.Add("Text", DataSource, "SoNgaydt6");
