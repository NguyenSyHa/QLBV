...
{
    public partial class Rep_79a_HD_1399_SP : DevExpress.XtraReports.UI.XtraReport
    {
        List<DTuong> _ldtuong = new List<DTuong>();
        public Rep_79a_HD_1399_SP()
        {
            InitializeComponent();
        ...
        public void BindingData()
        {
            ...
            colNgaykham.DataBindings.Add("Text", DataSource, "NgayTT").FormatString = this.DangNgay.Value.ToString();
        ...
        {
            if (this.GetCurrentColumnValue("SThe") != null && this.GetCurrentColumnValue("SThe").ToString().Length==2)
            {
                string dt = this.GetCurrentColumnValue("SThe").ToString();
        ...
        {
            if (this.GetCurrentColumnValue("GTinh") != null && this.GetCurrentColumnValue("NamSinh") != null)
            {
                int gt = Convert.ToInt32(this.GetCurrentColumnValue("GTinh").ToString());
                string ns = this.GetCurrentColumnValue("NamSinh").ToString();
                if (gt == 1)
                {
                    colNamsinh.Text = ns;
                    colGioitinh.Text = "";
