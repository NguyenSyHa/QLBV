...
{
    public partial class rep_TKTamThu_02 : DevExpress.XtraReports.UI.XtraReport
    {
        public rep_TKTamThu_02()
        {
            InitializeComponent();
        }
        ...
        public void BindingData() {
            ...
            colNgayThang.DataBindings.Add("Text", DataSource, "NgayThu").FormatString="{0:dd/MM}";
