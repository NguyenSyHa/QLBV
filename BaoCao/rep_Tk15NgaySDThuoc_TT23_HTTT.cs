...
{
    public partial class rep_Tk15NgaySDThuoc_TT23_HTTT : DevExpress.XtraReports.UI.XtraReport
    {
        public rep_Tk15NgaySDThuoc_TT23_HTTT()
        {
            InitializeComponent();
        }
           string[] _songay;
          ...
          public rep_Tk15NgaySDThuoc_TT23_HTTT(string[] ngay,  bool _in)
        {
            InitializeComponent();
            _songay = ngay;
