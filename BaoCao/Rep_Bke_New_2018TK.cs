...
{
    public partial class Rep_Bke_New_2018TK : DevExpress.XtraReports.UI.XtraReport
    {
        int _mabn = 0;
        ...
        string ngayUpdate = "";
        //
        public Rep_Bke_New_2018TK(int idper, int mabn)
        {
            InitializeComponent();
            _mabn = mabn;
        }
        public void Bindingdata()
        {
            ...
            if (DungChung.Bien.MaBV == "14017")
            {
                ...
                celDonGiaBV.DataBindings.Add("Text", DataSource, "DonGiaBV");
                celDonGiaBH.DataBindings.Add("Text", DataSource, "DonGiaBH");

                celThanhTienBH.DataBindings.Add("Text", DataSource, "ThanhTienBH");
                celThanhTienBV.DataBindings.Add("Text", DataSource, "ThanhTienBV");
                ...
                celTienBH.DataBindings.Add("Text", DataSource, "TienBH");
                ...
                celTienBN.DataBindings.Add("Text", DataSource, "TienBN");
                ...
                celTienNGDM.DataBindings.Add("Text", DataSource, "TienNgBH");
                ...
                coltienkhac.DataBindings.Add("Text", DataSource, "TienKhac");
            ...
            cellTenNhomDongTayY.DataBindings.Add("Text", DataSource, "TenDongTayY");
            ...
            GroupHeader3.SortingSummary.FieldName = "TenDongTayY";
        }
        int a = 1;
        ...
        private void ReportFooter_BeforePrint(object sender, CancelEventArgs e)
        {
            ...
            if (DungChung.Bien.MaBV == "14017" || DungChung.Bien.MaBV == "24012")
            {
                xrTable18.Visible = false;
            }
        }
        ...
        private void Rep_Bke_New_2018TK_BeforePrint(object sender, CancelEventArgs e)
        {
        ...
        private void _InSubReport(XRSubreport repsub)
        {
            ...
            BaoCao.rep_BkeNew_sub rep = new BaoCao.rep_BkeNew_sub();
            ...
            if (_lThuoc.Count > 0)
            {
                foreach (var item in _lThuoc)
                {
                    ...
                    moi.TenDongTayY = item.DongY == 1 ? "Thuốc đông y" : "Thuốc tây y, dịch truyền";
                    _lkq.Add(moi);
                }
            }
        ...
        private void GroupHeader3_BeforePrint(object sender, CancelEventArgs e)
        {
            ...
            if (tenDongY == null || string.IsNullOrWhiteSpace(this.GetCurrentColumnValue("TenDongTayY").ToString()) || (this.GetCurrentColumnValue("TenDongTayY").ToString() != "Thuốc đông y" && this.GetCurrentColumnValue("TenDongTayY").ToString() != "Thuốc tây y, dịch truyền"))
                e.Cancel = true;
        }
