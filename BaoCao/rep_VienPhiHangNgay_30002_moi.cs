...
{
    public partial class rep_VienPhiHangNgay_30002_moi : DevExpress.XtraReports.UI.XtraReport
    {
        private bool HienThi = false;//= true: chỉ hiển thị viện phí theo ngày

        public rep_VienPhiHangNgay_30002_moi()
        {
            InitializeComponent();
        }

        public rep_VienPhiHangNgay_30002_moi(bool hienthi)
        {
        ...
        internal void BindingData()
        {
            ...
            celBHNgoaiTru.DataBindings.Add("Text", DataSource, "TienBNBH").FormatString = DungChung.Bien.FormatString[1];
            celTienBNDV.DataBindings.Add("Text", DataSource, "TienBNDV").FormatString = DungChung.Bien.FormatString[1];
            ...
            celBHNgoaiTru_G.DataBindings.Add("Text", DataSource, "TienBNBH").FormatString = DungChung.Bien.FormatString[1];
            celTienBNDV_G.DataBindings.Add("Text", DataSource, "TienBNDV").FormatString = DungChung.Bien.FormatString[1];
            ...
            celBHNgoaiTru_R.DataBindings.Add("Text", DataSource, "TienBNBH").FormatString = DungChung.Bien.FormatString[1];
            celTienBNDV_R.DataBindings.Add("Text", DataSource, "TienBNDV").FormatString = DungChung.Bien.FormatString[1];
