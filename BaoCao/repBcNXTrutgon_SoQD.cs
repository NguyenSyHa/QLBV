...
{
    public partial class repBcNXTrutgon_SoQD : DevExpress.XtraReports.UI.XtraReport
    {
        public repBcNXTrutgon_SoQD()
        {
            InitializeComponent();
        }
        bool hiennhom = true;
        bool HTTrongNgoaiNuoc = false;
        public repBcNXTrutgon_SoQD(bool a, bool nk)
        {
            InitializeComponent();
            hiennhom = a;
            HTTrongNgoaiNuoc = nk;
        ...
        public void BindingData()
        {
            ...
            colMaTam.DataBindings.Add("Text", DataSource, "SoQD");
        ...
        private void ReportFooter_BeforePrint(object sender, CancelEventArgs e)
        {
            ...
            else if (DungChung.Bien.MaBV == "20001")
            {
                ...
                xrTableCell51.Text = "PHỤ TRÁCH DƯỢC";
            }
            else
            {
