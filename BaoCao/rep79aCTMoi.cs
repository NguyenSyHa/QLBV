...
{
    public partial class rep79aCTMoi : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        public rep79aCTMoi(string dtuong)
        {
            InitializeComponent();
            QLBV_Database.QLBVEntities _dataContext = new QLBV_Database.QLBVEntities(DungChung.Bien.StrCon);
            List<BNKB> bnkb = new List<BNKB>();
        ...
        private void colHotenBN_BeforePrint(object sender, CancelEventArgs e)
        {
