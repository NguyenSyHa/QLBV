...
{
    public partial class Rep_sub79b : DevExpress.XtraReports.UI.XtraReport
    {
        public Rep_sub79b()
        {
            InitializeComponent();
        ...
        public void BindingData()
        {
            ...
            colGF1Sotien.DataBindings.Add("Text", DataSource, "TongcongBHYT").FormatString = DungChung.Bien.FormatString[1];
            ...
            colRFSotien.DataBindings.Add("Text", DataSource, "TongcongBHYT").FormatString = DungChung.Bien.FormatString[1];
        ...
        private void colHoten_BeforePrint(object sender, CancelEventArgs e)
        {
            ...
            {
                txtNgayra.Text = this.GetCurrentColumnValue("NgayRa")
