...
{
    public partial class Rep_TongHop_XN_01071_XNKhac : DevExpress.XtraReports.UI.XtraReport
    {
        public Rep_TongHop_XN_01071_XNKhac()
        {
            InitializeComponent();
        }
        ...
        public Rep_TongHop_XN_01071_XNKhac(List<FormThamSo.Frm_TongHop_CLS.c_DSDV> lDichVu, List<FormThamSo.Frm_TongHop_CLS.BenhNhan> lSoLuongt)
        {
            InitializeComponent();
        ...
        public void BindingData()
        {
            ...
            colChanDoanRV.DataBindings.Add("Text", DataSource, "ChanDoanRV");
