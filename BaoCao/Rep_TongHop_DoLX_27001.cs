...
{
    public partial class Rep_TongHop_DoLX_27001 : DevExpress.XtraReports.UI.XtraReport
    {
        public Rep_TongHop_DoLX_27001()
        {
            InitializeComponent();
        }
        ...
        public Rep_TongHop_DoLX_27001(List<FormThamSo.Frm_TongHop_CLS.c_DSDV> lDichVu, List<FormThamSo.Frm_TongHop_CLS.BenhNhan> lSoLuongt)
        {
            InitializeComponent();
        ...
        public void BindingData()
        {
            ...
            {
                col_ngaythang.DataBindings.Add("Text", DataSource, "ngaythang").FormatString = "{0:dd/MM/yyyy}";
            }
        }
