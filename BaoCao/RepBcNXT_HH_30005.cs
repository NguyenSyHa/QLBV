...
{
    public partial class RepBcNXT_HH_30005 : DevExpress.XtraReports.UI.XtraReport
    {
        public RepBcNXT_HH_30005()
        {
            InitializeComponent();
        }
        bool _ht = true;
        bool HTTrongNgoaiNuoc = false;
        public RepBcNXT_HH_30005(bool ht, bool HTTrongNgoaiNuoc)
        {
            InitializeComponent();
            _ht = ht;
        ...
        public void BindingData()
        {
            ...
            colNhapTLSL.DataBindings.Add("Text", DataSource, "NhapTra_SL").FormatString = DungChung.Bien.FormatString[0];
            colNhapTLTTde.DataBindings.Add("Text", DataSource, "NhapTra_TT").FormatString = DungChung.Bien.FormatString[1];
            colNhapTLTTTong.DataBindings.Add("Text", DataSource, "NhapTra_TT").FormatString = DungChung.Bien.FormatString[1];
            colNhapTLTTGf1.DataBindings.Add("Text", DataSource, "NhapTra_TT").FormatString = DungChung.Bien.FormatString[1];
            colNhapTLTTGf2.DataBindings.Add("Text", DataSource, "NhapTra_TT").FormatString = DungChung.Bien.FormatString[1];
            colNhapTLTTGf3.DataBindings.Add("Text", DataSource, "NhapTra_TT").FormatString = DungChung.Bien.FormatString[1];
            colNhapTLTTTong.Summary.FormatString = DungChung.Bien.FormatString[1];
            colNhapTLTTGf1.Summary.FormatString = DungChung.Bien.FormatString[1];
            colNhapTLTTGf2.Summary.FormatString = DungChung.Bien.FormatString[1];
            colNhapTLTTGf3.Summary.FormatString = DungChung.Bien.FormatString[1];
