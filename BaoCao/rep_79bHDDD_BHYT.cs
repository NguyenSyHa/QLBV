...
{
    public partial class rep_79bHDDD_BHYT : DevExpress.XtraReports.UI.XtraReport
    {
        public rep_79bHDDD_BHYT()
        {
            InitializeComponent();
        }
        ...
        private void xrLabel7_BeforePrint(object sender, CancelEventArgs e)
        {
            ...
            var q = (from bn in _Data.BenhNhans.Where(p => p.DTuong == "BHYT").Where(p => p.NoiTru == 0)
                     ...
                     group new { bn, vpct, rv, nhom } by new { vp.Duyet,bn.NoiTinh, bn.MaBNhan,rv.SoNgaydt} into kq
                     select new
                     {
                         ...
                         tiengiuong = kq.Where(p => p.nhom.TenNhom.Contains("khám")).Sum(p => p.vpct.TienBH),
                         tiengiuongCL = kq.Where(p => p.nhom.TenNhom.Contains("khám")).Sum(p => p.vpct.TienBH) - kq.Where(p => p.nhom.TenNhom.Contains("khám")).Sum(p => p.vpct.TienChenh),
            ...
            var q1 = (from bn in _Data.BenhNhans.Where(p => p.DTuong == "BHYT").Where(p => p.NoiTru == 0)
                      join vp in _Data.VienPhis on bn.MaBNhan equals vp.MaBNhan
                      join vpct in _Data.VienPhicts.Where(p => p.TrongBH == 1) on vp.idVPhi equals vpct.idVPhi
                      join dv in _Data.DichVus on vpct.MaDV equals dv.MaDV
                      join nhom in _Data.NhomDVs on dv.IDNhom equals nhom.IDNhom
            ...
            var q2 = (from b in q1
                      ...
                      select new
                      {
                          ...
                          tiengiuong = kq.Where(p => p.b.TenNhomCT== ("Khám bệnh")).Sum(p => p.b.TienBH),
                          tiengiuongCL = kq.Where(p => p.b.TenNhomCT== ("Khám bệnh")).Sum(p => p.b.TienBH) - kq.Where(p => p.b.TenNhomCT== ("Khám bệnh")).Sum(p => p.b.TienChenh),
            ...
            if (q.Where(p => p.duyet != 0).Where(p=>p.duyet!=3).ToList().Count > 0)
            {
                double a = 0;
                ...
                if (q.Where(p => p.Noitinh == 1).Where(p => p.duyet != 0).Where(p=>p.duyet!=3).ToList().Count > 0 && q.Where(p => p.Noitinh == 1).Where(p => p.duyet != 0).Where(p=>p.duyet!=3).First().Vanchuyen != null)
                {
                    ...
                    double d = Convert.ToDouble(q.Where(p => p.duyet != 0).Where(p => p.duyet != 3).Where(p => p.Noitinh == 1).Sum(p=>p.VanchuyenCL));
                ...
                if (q.Where(p => p.Noitinh == 1).Where(p => p.duyet != 0).Where(p => p.duyet != 3).ToList().Count > 0 && q.Where(p => p.Noitinh == 1).Where(p => p.duyet != 0).Where(p => p.duyet != 3).First().BHYT != null)
                {
                   if(q.Where(p => p.Noitinh == 1).Where(p => p.duyet == 1).ToList().Count>0)
                    a = Convert.ToDouble(q.Where(p => p.Noitinh == 1).Where(p => p.duyet == 1).First().BHYT);
                    xrTableCell146.Text = a.ToString("##,###");
                    double d = Convert.ToDouble(q.Where(p=>p.duyet!=0).Where(p=>p.duyet!=3).Where(p => p.Noitinh == 1).Sum(p=>p.BHYT));
                    xrTableCell321.Text = d.ToString("##,###");
                    b1 = d - Convert.ToDouble(q.Where(p => p.duyet != 0).Where(p => p.duyet != 3).Where(p => p.Noitinh == 1).Sum(p => p.Vanchuyen));
                ...
                if (q.Where(p => p.Noitinh == 2).Where(p => p.duyet != 0).Where(p => p.duyet != 3).ToList().Count > 0 && q.Where(p => p.Noitinh == 2).Where(p => p.duyet != 0).Where(p => p.duyet != 3).First().Vanchuyen != null)
                {
                    ...
                    double d = Convert.ToDouble(q.Where(p => p.Noitinh == 2).Where(p => p.duyet != 0).Where(p => p.duyet != 3).Sum(p => p.VanchuyenCL));
                ...
                if (q.Where(p => p.Noitinh == 2).Where(p => p.duyet != 0).Where(p => p.duyet != 3).ToList().Count > 0 && q.Where(p => p.Noitinh == 2).Where(p => p.duyet != 0).Where(p => p.duyet != 3).First().BHYT != null)
                {
                    if (q.Where(p => p.Noitinh == 2).Where(p => p.duyet == 1).ToList().Count>0)
                    a = Convert.ToDouble(q.Where(p => p.Noitinh == 2).Where(p => p.duyet == 1).First().BHYT);
                    xrTableCell165.Text = a.ToString("##,###");
                    double d = Convert.ToDouble(q.Where(p=>p.duyet!=0).Where(p=>p.duyet!=3).Where(p => p.Noitinh == 2).Sum(p=>p.BHYTCL));
                    xrTableCell339.Text = d.ToString("##,###");
                    b2 = d - Convert.ToDouble(q.Where(p => p.duyet != 0).Where(p => p.duyet != 3).Where(p => p.Noitinh == 2).Sum(p => p.VanchuyenCL));
                ...
                if (q.Where(p => p.Noitinh == 3).Where(p => p.duyet != 0).Where(p => p.duyet != 3).ToList().Count > 0 && q.Where(p => p.Noitinh == 3).Where(p => p.duyet != 0).Where(p => p.duyet != 3).First().Vanchuyen != null)
                {
                    a = Convert.ToDouble(q.Where(p => p.Noitinh == 3).Where(p => p.duyet != 0).Where(p => p.duyet != 3).First().Vanchuyen);
                    xrTableCell182.Text = a.ToString("##,###");
                    xrTableCell78.Text = a.ToString("##,###");
                    double d = Convert.ToDouble(q.Where(p => p.Noitinh == 3).Where(p => p.duyet != 0).Where(p => p.duyet != 3).Sum(p=>p.VanchuyenCL));
                ...
                if (q.Where(p => p.Noitinh == 3).Where(p => p.duyet != 0).Where(p => p.duyet != 3).ToList().Count > 0 && q.Where(p => p.Noitinh == 3).Where(p => p.duyet != 0).Where(p => p.duyet != 3).First().BHYT != null)
                {
                    if(q.Where(p => p.Noitinh == 3).Where(p => p.duyet == 1).ToList().Count>0)
                    a = Convert.ToDouble(q.Where(p => p.Noitinh == 3).Where(p => p.duyet == 1).First().BHYT);
                    xrTableCell184.Text = a.ToString("##,###");
                    double d = Convert.ToDouble(q.Where(p=>p.duyet!=0).Where(p=>p.duyet!=3).Where(p => p.Noitinh == 3).Sum(p=>p.BHYTCL));
                    xrTableCell333.Text = d.ToString("##,###");
                    b3 = d - Convert.ToDouble(q.Where(p => p.duyet != 0).Where(p => p.duyet != 3).Where(p => p.Noitinh == 3).Sum(p=>p.VanchuyenCL));
                ...
                if (q.Where(p => p.duyet != 0).Where(p=>p.duyet!=3).Sum(p => p.Vanchuyen) != null)
                {
                    a = Convert.ToDouble(q.Where(p => p.duyet == 1).Sum(p => p.Vanchuyen));
                    xrTableCell201.Text = a.ToString("##,###");
                    xrTableCell96.Text = a.ToString("##,###");
                    double d = Convert.ToDouble(q.Where(p => p.duyet != 0).Where(p => p.duyet != 3).Sum(p => p.VanchuyenCL));
                ...
                if (q.Where(p => p.duyet != 0).Where(p => p.duyet != 3).Sum(p => p.BHYT) != null)
                {
                    if (q.Where(p => p.duyet == 1).ToList().Count>0)
                    a = Convert.ToDouble(q.Where(p => p.duyet == 1).Sum(p => p.BHYT));
                    xrTableCell203.Text = a.ToString("##,###");
                    double d = Convert.ToDouble(q.Where(p => p.duyet != 0).Where(p=>p.duyet!=3).Sum(p => p.BHYT));
                    xrTableCell327.Text = d.ToString("##,###");
                    c = a;
                    b4 = d - Convert.ToDouble(q.Where(p=>p.duyet!=0).Where(p=>p.duyet!=3).Sum(p => p.VanchuyenCL));
            ...
            if (q.Where(p => p.duyet !=0).Where(p=>p.duyet!=1).ToList().Count > 0)
            {
                ...
                if (q.Where(p => p.Noitinh == 1).Where(p => p.duyet != 0).Where(p => p.duyet != 1).ToList().Count > 0 && q.Where(p => p.Noitinh == 1).Where(p => p.duyet != 0).Where(p => p.duyet != 1).First().Tongcong != null)
                {
                    a = Convert.ToDouble(q.Where(p => p.Noitinh == 1).Where(p => p.duyet != 0).Where(p => p.duyet != 1).First().TongcongCL);
                    //double e=
                    xrTableCell235.Text = a.ToString("##,###");
                }
                if (q.Where(p => p.Noitinh == 1).Where(p => p.duyet != 0).Where(p => p.duyet != 1).ToList().Count > 0 && q.Where(p => p.Noitinh == 1).Where(p => p.duyet != 0).Where(p => p.duyet != 1).First().Xetnghiem != null)
                {
                    a = Convert.ToDouble(q.Where(p => p.Noitinh == 1).Where(p => p.duyet != 0).Where(p => p.duyet != 1).First().XetnghiemCL);
                    xrTableCell236.Text = a.ToString("##,###");
                }
                if (q.Where(p => p.Noitinh == 1).Where(p => p.duyet != 0).Where(p => p.duyet != 1).ToList().Count > 0 && q.Where(p => p.Noitinh == 1).Where(p => p.duyet != 0).Where(p => p.duyet != 1).First().CDHA != null)
                {
                    a = Convert.ToDouble(q.Where(p => p.Noitinh == 1).Where(p => p.duyet != 0).Where(p => p.duyet != 1).First().CDHACL);
                    xrTableCell237.Text = a.ToString("##,###");
                }
                if (q.Where(p => p.Noitinh == 1).Where(p => p.duyet != 0).Where(p => p.duyet != 1).ToList().Count > 0 && q.Where(p => p.Noitinh == 1).Where(p => p.duyet != 0).Where(p => p.duyet != 1).First().Thuoc != null)
                {
                    a = Convert.ToDouble(q.Where(p => p.Noitinh == 1).Where(p => p.duyet != 0).Where(p => p.duyet != 1).First().ThuocCL);
                    xrTableCell238.Text = a.ToString("##,###");
                }
                if (q.Where(p => p.Noitinh == 1).Where(p => p.duyet != 0).Where(p => p.duyet != 1).ToList().Count > 0 && q.Where(p => p.Noitinh == 1).Where(p => p.duyet != 0).Where(p => p.duyet != 1).First().Mau != null)
                {
                    a = Convert.ToDouble(q.Where(p => p.Noitinh == 1).Where(p => p.duyet != 0).Where(p => p.duyet != 1).First().MauCL);
                    xrTableCell239.Text = a.ToString("##,###");
                }
                if (q.Where(p => p.Noitinh == 1).Where(p => p.duyet != 0).Where(p => p.duyet != 1).ToList().Count > 0 && q.Where(p => p.Noitinh == 1).Where(p => p.duyet != 0).Where(p => p.duyet != 1).First().TTPT != null)
                {
                    a = Convert.ToDouble(q.Where(p => p.Noitinh == 1).Where(p => p.duyet != 0).Where(p => p.duyet != 1).First().TTPTCL);
                    xrTableCell240.Text = a.ToString("##,###");
                }
                if (q.Where(p => p.Noitinh == 1).Where(p => p.duyet != 0).Where(p => p.duyet != 1).ToList().Count > 0 && q.Where(p => p.Noitinh == 1).Where(p => p.duyet != 0).Where(p => p.duyet != 1).First().VTTH != null)
                {
                    a = Convert.ToDouble(q.Where(p => p.Noitinh == 1).Where(p => p.duyet != 0).Where(p => p.duyet != 1).First().VTTHCL);
                ...
                if (q.Where(p => p.Noitinh == 1).Where(p => p.duyet == 2).ToList().Count > 0 && q.Where(p => p.Noitinh == 1).Where(p => p.duyet != 0).Where(p => p.duyet != 1).First().Nguoibenh != null)
                {
                    a = Convert.ToDouble(q.Where(p => p.Noitinh == 1).Where(p => p.duyet != 0).Where(p => p.duyet != 1).First().Nguoibenh);
                ...
                if (q.Where(p => p.Noitinh == 2).Where(p => p.duyet != 0).Where(p => p.duyet != 1).ToList().Count > 0 && q.Where(p => p.Noitinh == 2).Where(p => p.duyet != 0).Where(p => p.duyet != 1).First().songay != null)//gjhgjhg
                {
                ...
                {
                    a = Convert.ToDouble(q.Where(p => p.Noitinh == 2).Where(p => p.duyet != 0).Where(p => p.duyet != 1).First().Nguoibenh);
                ...
                {
                    a = Convert.ToDouble(q.Where(p => p.Noitinh == 3).Where(p => p.duyet != 0).Where(p => p.duyet != 1).Sum(p => p.songay));
                ...
                {
                    a = Convert.ToDouble(q.Where(p => p.duyet != 0).Where(p => p.duyet != 1).Sum(p => p.songay));
                ...
                if (q.Where(p => p.duyet != 0).Where(p => p.duyet != 1).Sum(p => p.Nguoibenh) != null)
                {
