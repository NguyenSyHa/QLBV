...
{
    public partial class rep_VienPhiHangNgay_30005_moi : DevExpress.XtraReports.UI.XtraReport
    {
        private bool HienThi = false;//= true: chỉ hiển thị viện phí theo ngày

        public rep_VienPhiHangNgay_30005_moi()
        {
            InitializeComponent();
        }

        public rep_VienPhiHangNgay_30005_moi(bool hienthi)
        {
