...
{
    public partial class rep_VienPhiHangNgay_30003_moi : DevExpress.XtraReports.UI.XtraReport
    {
        private bool HienThi = false;//= true: chỉ hiển thị viện phí theo ngày

        public rep_VienPhiHangNgay_30003_moi()
        {
            InitializeComponent();
        }

        public rep_VienPhiHangNgay_30003_moi(bool hienthi)
        {
        ...
        internal void BindingData()
        {
            ...
            celSoPhieu.DataBindings.Add("Text", DataSource, "SoHD");

            celGiuong.DataBindings.Add("Text", DataSource, "Giuong").FormatString = DungChung.Bien.FormatString[1];
            ...
            celSieuAmDL.DataBindings.Add("Text", DataSource, "SieuAmDL").FormatString = DungChung.Bien.FormatString[1];
            ...
            celChupXQCT.DataBindings.Add("Text", DataSource, "ChupCT").FormatString = DungChung.Bien.FormatString[1];          
            ...
            celTienNGDM.DataBindings.Add("Text", DataSource, "TienNGDM").FormatString = DungChung.Bien.FormatString[1];
            CelThuoc.DataBindings.Add("Text", DataSource, "TienThuoc").FormatString = DungChung.Bien.FormatString[1];
            celVTYT.DataBindings.Add("Text", DataSource, "TienVTYT").FormatString = DungChung.Bien.FormatString[1];
            
            celTong.DataBindings.Add("Text", DataSource, "Tong").FormatString = DungChung.Bien.FormatString[1];

            celGiuong_G.DataBindings.Add("Text", DataSource, "Giuong").FormatString = DungChung.Bien.FormatString[1];
            ...
            celSieuAmDL_G.DataBindings.Add("Text", DataSource, "SieuAmDL").FormatString = DungChung.Bien.FormatString[1];
            ...
            celChupXQCT_G.DataBindings.Add("Text", DataSource, "ChupCT").FormatString = DungChung.Bien.FormatString[1];
            ...
            celTienNGDM_G.DataBindings.Add("Text", DataSource, "TienNGDM").FormatString = DungChung.Bien.FormatString[1];
            ...
            celThuoc_G.DataBindings.Add("Text", DataSource, "TienThuoc").FormatString = DungChung.Bien.FormatString[1];
            celVTYT_G.DataBindings.Add("Text", DataSource, "TienVTYT").FormatString = DungChung.Bien.FormatString[1];

            celGiuong_R.DataBindings.Add("Text", DataSource, "Giuong").FormatString = DungChung.Bien.FormatString[1];
            ...
            celSieuAmDL_R.DataBindings.Add("Text", DataSource, "SieuAmDL").FormatString = DungChung.Bien.FormatString[1];
            ...
            celChupXQCT_R.DataBindings.Add("Text", DataSource, "ChupCT").FormatString = DungChung.Bien.FormatString[1];
            ...
            celTienNGDM_R.DataBindings.Add("Text", DataSource, "TienNGDM").FormatString = DungChung.Bien.FormatString[1];
            ...
            celThuoc_R.DataBindings.Add("Text", DataSource, "TienThuoc").FormatString = DungChung.Bien.FormatString[1];
            celVTYT_R.DataBindings.Add("Text", DataSource, "TienVTYT").FormatString = DungChung.Bien.FormatString[1];
           if(HienThi)
