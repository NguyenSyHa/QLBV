...
{
    public partial class Rep_Th_CDHA_XQuang : DevExpress.XtraReports.UI.XtraReport
    {
        public Rep_Th_CDHA_XQuang()
        {
            InitializeComponent();
        }
        ...
        public Rep_Th_CDHA_XQuang(List<FormThamSo.Frm_TongHop_CLS.c_DSDV> lDichVu, List<FormThamSo.Frm_TongHop_CLS.BenhNhan> lSoLuongt)
        {
            InitializeComponent();
        ...
        public void BindingData()
        {
            ...
            cell_YBSCD.DataBindings.Add("Text", DataSource, "TenCBcd");
            cell_DTVP.DataBindings.Add("Text", DataSource, "DichVu");
            cell1318.DataBindings.Add("Text", DataSource, "colKQ1");
            cell1824.DataBindings.Add("Text", DataSource, "colKQ2");
            cell2430.DataBindings.Add("Text", DataSource, "colKQ3");
            cell3040.DataBindings.Add("Text", DataSource, "colKQ4");
            ...
            if(DungChung.Bien.MaBV == "20001")
            {
                colCKham.DataBindings.Add("Text", DataSource, "LoiDan");
