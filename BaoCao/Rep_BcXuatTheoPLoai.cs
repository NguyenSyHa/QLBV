...
{
    public partial class Rep_BcXuatTheoPLoai : DevExpress.XtraReports.UI.XtraReport
    {
        public Rep_BcXuatTheoPLoai()
        {
            InitializeComponent();
        }
        string _kho="";
        public Rep_BcXuatTheoPLoai(string k)
        {
            InitializeComponent();
            _kho = k;
        }
        public void BindingData()
        {
           ...
           // txtMaDV.DataBindings.Add("Text", DataSource, "MaDV");
            ...
            colSLX8.DataBindings.Add("Text", DataSource, "SL8").FormatString = DungChung.Bien.FormatString[1];
            colSLX9.DataBindings.Add("Text", DataSource, "SL9").FormatString = DungChung.Bien.FormatString[1];
            colSLX10.DataBindings.Add("Text", DataSource, "SL10").FormatString = DungChung.Bien.FormatString[1];
            colSLX11.DataBindings.Add("Text", DataSource, "SL11").FormatString = DungChung.Bien.FormatString[1];
            colSLX12.DataBindings.Add("Text", DataSource, "SL12").FormatString = DungChung.Bien.FormatString[1];
            colSLX13.DataBindings.Add("Text", DataSource, "SL13").FormatString = DungChung.Bien.FormatString[1];
            colSLX14.DataBindings.Add("Text", DataSource, "SL14").FormatString = DungChung.Bien.FormatString[1];
            colSLX15.DataBindings.Add("Text", DataSource, "SL15").FormatString = DungChung.Bien.FormatString[1];
            colSLX16.DataBindings.Add("Text", DataSource, "SL16").FormatString = DungChung.Bien.FormatString[1];
            colSLX17.DataBindings.Add("Text", DataSource, "SL17").FormatString = DungChung.Bien.FormatString[1];
            colSLX18.DataBindings.Add("Text", DataSource, "SL18").FormatString = DungChung.Bien.FormatString[1];
            colSLX19.DataBindings.Add("Text", DataSource, "SL").FormatString = DungChung.Bien.FormatString[1];
