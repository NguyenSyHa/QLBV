...
{
    public partial class Rep_Th_CDHA_SieuAm : DevExpress.XtraReports.UI.XtraReport
    {
        public Rep_Th_CDHA_SieuAm()
        {
            InitializeComponent();
        }
        ...
        public Rep_Th_CDHA_SieuAm(List<FormThamSo.Frm_TongHop_CLS.c_DSDV> lDichVu, List<FormThamSo.Frm_TongHop_CLS.BenhNhan> lSoLuongt)
        {
            InitializeComponent();
        ...
        public void BindingData()
        {
            ...
            colKQ.DataBindings.Add("Text", DataSource, "KetQua");
            colTenCBth.DataBindings.Add("Text", DataSource, "TenCBth");
            colYeuCau3D_4D.DataBindings.Add("Text", DataSource, "colKQ3");
            colYeuCau2D.DataBindings.Add("Text", DataSource, "colKQ1");
            colYeuCauMau.DataBindings.Add("Text", DataSource, "colKQ2");
