...
{
    public partial class rep_Tk30NgaySDThuoc_TT23 : DevExpress.XtraReports.UI.XtraReport
    {
        public rep_Tk30NgaySDThuoc_TT23()
        {
            InitializeComponent();
        }
           string[] _songay;
          ...
          public rep_Tk30NgaySDThuoc_TT23(string[] ngay)
        {
            InitializeComponent();
            _songay = ngay;
        }
