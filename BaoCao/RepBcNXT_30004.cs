...
{
    public partial class RepBcNXT_30004 : DevExpress.XtraReports.UI.XtraReport
    {
        public RepBcNXT_30004()
        {
            InitializeComponent();
        }
        bool _ht = true;
        ...
        int ma = -1;
        public RepBcNXT_30004(bool ht, bool nk, int aa)
        {
            InitializeComponent();
            _ht = ht;
            HTTrongNgoaiNuoc = nk;
        ...
        public void BindingData()
        {
            ...
            colXuatKhacSL.DataBindings.Add("Text", DataSource, "XuatKhacSL2").FormatString = DungChung.Bien.FormatString[0];
            colXuatKhacTT.DataBindings.Add("Text", DataSource, "xuatKhacTT2").FormatString = DungChung.Bien.FormatString[1];
            colXuatKhacTTGF1.DataBindings.Add("Text", DataSource, "XuatKhacTT2").FormatString = DungChung.Bien.FormatString[1];
            colXuatKhacTTGF2.DataBindings.Add("Text", DataSource, "XuatKhacTT2").FormatString = DungChung.Bien.FormatString[1];
            colXuatKhacTTGF3.DataBindings.Add("Text", DataSource, "XuatKhacTT2").FormatString = DungChung.Bien.FormatString[1];
            colXuatKhacTTRF.DataBindings.Add("Text", DataSource, "XuatKhacTT2").FormatString = DungChung.Bien.FormatString[1];
            ...
            colXuatC3TTGf1.DataBindings.Add("Text", DataSource, "XuatC3TT").FormatString = DungChung.Bien.FormatString[1];
            colXuatC3TTGf2.DataBindings.Add("Text", DataSource, "XuatC3TT").FormatString = DungChung.Bien.FormatString[1];
            colXuatC3TTGf3.DataBindings.Add("Text", DataSource, "XuatC3TT").FormatString = DungChung.Bien.FormatString[1];
            colXuatC3TTTong.DataBindings.Add("Text", DataSource, "XuatC3TT").FormatString = DungChung.Bien.FormatString[1];
            colXuatC3TTGf1.Summary.FormatString = DungChung.Bien.FormatString[1];
            colXuatC3TTGf2.Summary.FormatString = DungChung.Bien.FormatString[1];
            colXuatC3TTGf3.Summary.FormatString = DungChung.Bien.FormatString[1];
            colXuatC3TTTong.Summary.FormatString = DungChung.Bien.FormatString[1];

            colXuatC4SL.DataBindings.Add("Text", DataSource, "XuatC4SL").FormatString = DungChung.Bien.FormatString[0];
            colXuatC4TT.DataBindings.Add("Text", DataSource, "XuatC4TT").FormatString = DungChung.Bien.FormatString[1];
            colXuatC4TTGr1.DataBindings.Add("Text", DataSource, "XuatC4TT").FormatString = DungChung.Bien.FormatString[1];
            colXuatC4TTGr2.DataBindings.Add("Text", DataSource, "XuatC4TT").FormatString = DungChung.Bien.FormatString[1];
            colXuatC4TTGr3.DataBindings.Add("Text", DataSource, "XuatC4TT").FormatString = DungChung.Bien.FormatString[1];
            colXuatC4TTTong.DataBindings.Add("Text", DataSource, "XuatC4TT").FormatString = DungChung.Bien.FormatString[1];
            colXuatC4TTGr1.Summary.FormatString = DungChung.Bien.FormatString[1];
            colXuatC4TTGr2.Summary.FormatString = DungChung.Bien.FormatString[1];
            colXuatC4TTGr3.Summary.FormatString = DungChung.Bien.FormatString[1];
            colXuatC4TTTong.Summary.FormatString = DungChung.Bien.FormatString[1];
