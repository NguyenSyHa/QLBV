...
{
    public partial class rep_BCDoiChieuGia_TT39_27001 : DevExpress.XtraReports.UI.XtraReport
    {
        public rep_BCDoiChieuGia_TT39_27001()
        {
            InitializeComponent();
        }
        ...
        internal void BindingData()
        {
            ...
            cel7.DataBindings.Add("Text", DataSource, "DonGiaBHYT").FormatString = DungChung.Bien.FormatString[1];
            cel8.DataBindings.Add("Text", DataSource, "ThanhTienBHYT").FormatString = DungChung.Bien.FormatString[1];            

            cel9.DataBindings.Add("Text", DataSource, "DonGiaTT15").FormatString = DungChung.Bien.FormatString[1];
            cel10.DataBindings.Add("Text", DataSource, "ThanhTienTT15").FormatString = DungChung.Bien.FormatString[1];

            cel11.DataBindings.Add("Text", DataSource, "DonGiaTT39").FormatString = DungChung.Bien.FormatString[1];
            cel12.DataBindings.Add("Text", DataSource, "ThanhTienTT39").FormatString = DungChung.Bien.FormatString[1];

            cel13.DataBindings.Add("Text", DataSource, "ChenhLech").FormatString = DungChung.Bien.FormatString[1];
            cel14.DataBindings.Add("Text", DataSource, "ChenhLechDV").FormatString = DungChung.Bien.FormatString[1];

            cel15.DataBindings.Add("Text", DataSource, "ChenhLech39DV").FormatString = DungChung.Bien.FormatString[1];
            cel16.DataBindings.Add("Text", DataSource, "ChenhLech39_37").FormatString = DungChung.Bien.FormatString[1];
            cel18.DataBindings.Add("Text", DataSource, "Thang");
            cel19.DataBindings.Add("Text", DataSource, "tuyen");
            cel20.DataBindings.Add("Text", DataSource, "Loai");
            ...
            xrTableCell142.DataBindings.Add("Text", DataSource, "ThanhTienTT39").FormatString = DungChung.Bien.FormatString[1];
            xrTableCell143.DataBindings.Add("Text", DataSource, "ThanhTienTT39").FormatString = DungChung.Bien.FormatString[1];
            xrTableCell144.DataBindings.Add("Text", DataSource, "ThanhTienTT39").FormatString = DungChung.Bien.FormatString[1];
            xrTableCell145.DataBindings.Add("Text", DataSource, "ThanhTienTT39").FormatString = DungChung.Bien.FormatString[1];

            xrTableCell48.DataBindings.Add("Text", DataSource, "ChenhLech").FormatString = DungChung.Bien.FormatString[1];
            xrTableCell50.DataBindings.Add("Text", DataSource, "ChenhLech").FormatString = DungChung.Bien.FormatString[1];
            xrTableCell45.DataBindings.Add("Text", DataSource, "ChenhLech").FormatString = DungChung.Bien.FormatString[1];
            xrTableCell52.DataBindings.Add("Text", DataSource, "ChenhLech").FormatString = DungChung.Bien.FormatString[1];

            xrTableCell47.DataBindings.Add("Text", DataSource, "ChenhLechDV").FormatString = DungChung.Bien.FormatString[1];
            xrTableCell49.DataBindings.Add("Text", DataSource, "ChenhLechDV").FormatString = DungChung.Bien.FormatString[1];
            xrTableCell43.DataBindings.Add("Text", DataSource, "ChenhLechDV").FormatString = DungChung.Bien.FormatString[1];
            xrTableCell51.DataBindings.Add("Text", DataSource, "ChenhLechDV").FormatString = DungChung.Bien.FormatString[1];
            ...
            celTienChenh2G1.DataBindings.Add("Text", DataSource, "ChenhLech39_37").FormatString = DungChung.Bien.FormatString[1];
            celTienChenh2G2.DataBindings.Add("Text", DataSource, "ChenhLech39_37").FormatString = DungChung.Bien.FormatString[1];
            celTienChenh2R.DataBindings.Add("Text", DataSource, "ChenhLech39_37").FormatString = DungChung.Bien.FormatString[1];
            xrTableCell131.DataBindings.Add("Text", DataSource, "ChenhLech39_37").FormatString = DungChung.Bien.FormatString[1];
