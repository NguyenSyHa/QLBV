...
{
    public partial class Rep_BcKhamChuaBenh_CL : DevExpress.XtraReports.UI.XtraReport
    {
        public Rep_BcKhamChuaBenh_CL()
        {
            InitializeComponent();
        }
        ...
        {
            colTruongKhoa.Text = DungChung.Bien.NguoiLapBieu;
        }
    }
}
