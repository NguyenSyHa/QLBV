...
{
    public partial class Rep_SoPhauThuat_ThuThuat_408 : DevExpress.XtraReports.UI.XtraReport
    {
        public Rep_SoPhauThuat_ThuThuat_408()
        {
            InitializeComponent();
        }
        ...
        public void BindingData()
        {
            ...
            colNgayPT.DataBindings.Add("Text", DataSource, "ngaythang").FormatString = "{0:dd/MM/yy }";
