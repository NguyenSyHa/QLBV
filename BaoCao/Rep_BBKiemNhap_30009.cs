...
{
    public partial class Rep_BBKiemNhap_30009 : DevExpress.XtraReports.UI.XtraReport
    {
        List<string> _a = new List<string>();
        public Rep_BBKiemNhap_30009(List<string> a)
        {
            InitializeComponent();
            _a = a;
        }
        ...
        { 
            ...
            colQuycach1.DataBindings.Add("Text", DataSource, "QCPC");
            //colGhiChu1.DataBindings.Add("Text", DataSource, "SoLo");
            ...
            txtNhaSX.DataBindings.Add("Text", DataSource, "MaQD");
            ...
            // colSoLuongGh22.DataBindings.Add("Text", DataSource, "SoLuong").FormatString = DungChung.Bien.FormatString[1];
            // colSoLuongGh21.DataBindings.Add("Text", DataSource, "SoLuong").FormatString = DungChung.Bien.FormatString[1];
            colSoLuong1.DataBindings.Add("Text", DataSource, "SoLuongN").FormatString = DungChung.Bien.FormatString[1];
            // colThanhTienGh22.DataBindings.Add("Text", DataSource, "ThanhTien").FormatString =DungChung.Bien.FormatString[1];
            // colThanhTienGh21.DataBindings.Add("Text", DataSource, "ThanhTien").FormatString = DungChung.Bien.FormatString[1];
            colThanhTien1.DataBindings.Add("Text", DataSource, "ThanhTienN").FormatString = DungChung.Bien.FormatString[1];
            //GroupHeader4.GroupFields.Add(new GroupField("TenNhomDuoc"));
            //GroupHeader3.GroupFields.Add(new GroupField("TenTieuNhomDuoc"));
        }
