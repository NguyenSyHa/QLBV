...
{
    public partial class Rep_79a_HD_1399_Tyle_TienGiuong : DevExpress.XtraReports.UI.XtraReport
    {
      public  bool HtTuyen = true;
      public bool HtMaICD = false;
      int _a = 0;
        List<DTuong> _ldtuong = new List<DTuong>();
        public Rep_79a_HD_1399_Tyle_TienGiuong(int a)
        {
            InitializeComponent();
        ...
        public void BindingData(string kieuNgay,int a)
        {
            ...
            colCPNgoaiBHYT.DataBindings.Add("Text", DataSource, "T_vchuyen").FormatString = DungChung.Bien.FormatString[1];
          ...
          //  txtGioitinh.DataBindings.Add("Text", DataSource, "Gioi_tinh");
            ...
            celTyLeBHTT.DataBindings.Add("Text", DataSource, "TyLeBHTT");
          //  txtNamsinh.DataBindings.Add("Text", DataSource, "NSinh");
            ...
            {
                colXetnghiemRF24272.DataBindings.Add("Text", DataSource, "T_xn").FormatString = DungChung.Bien.FormatString[1];
                colTongcongRF24272.DataBindings.Add("Text", DataSource, "Thanhtien").FormatString = DungChung.Bien.FormatString[1];
                colCDHARF24272.DataBindings.Add("Text", DataSource, "T_cdha").FormatString = DungChung.Bien.FormatString[1];
                colThuocRF24272.DataBindings.Add("Text", DataSource, "T_thuoc").FormatString = DungChung.Bien.FormatString[1];
                colMauRF24272.DataBindings.Add("Text", DataSource, "T_mau").FormatString = DungChung.Bien.FormatString[1];
                colTTPTRF24272.DataBindings.Add("Text", DataSource, "T_pttt").FormatString = DungChung.Bien.FormatString[1];
                colVTYTRF24272.DataBindings.Add("Text", DataSource, "T_vtyt").FormatString = DungChung.Bien.FormatString[1];
                colDVKT_tl_RF24272.DataBindings.Add("Text", DataSource, "T_dvkt_tyle").FormatString = DungChung.Bien.FormatString[1];
                colThuoc_tl_RF24272.DataBindings.Add("Text", DataSource, "T_thuoc_tyle").FormatString = DungChung.Bien.FormatString[1];
                colVTYT_tl_RF24272.DataBindings.Add("Text", DataSource, "T_vtyt_tyle").FormatString = DungChung.Bien.FormatString[1];
                colcongkhamRF24272.DataBindings.Add("Text", DataSource, "T_kham").FormatString = DungChung.Bien.FormatString[1];
                colTienGiuongF24272.DataBindings.Add("Text", DataSource, "T_giuong").FormatString = DungChung.Bien.FormatString[1];
                colCPVCRF24272.DataBindings.Add("Text", DataSource, "T_vchuyen").FormatString = DungChung.Bien.FormatString[1];
                colNguoibenhchitraRF24272.DataBindings.Add("Text", DataSource, "T_bntt").FormatString = DungChung.Bien.FormatString[1];
                colTongcongBHYTRF24272.DataBindings.Add("Text", DataSource, "T_bhtt").FormatString = DungChung.Bien.FormatString[1];
                colCPNgoaiBHYTRF24272.DataBindings.Add("Text", DataSource, "T_vchuyen").FormatString = DungChung.Bien.FormatString[1];
            }
            else
            {
                ...
                colTienGiuongF.DataBindings.Add("Text", DataSource, "T_giuong").FormatString = DungChung.Bien.FormatString[1];
