...
{
    public partial class Rep_TongHopHoaSinhMau : DevExpress.XtraReports.UI.XtraReport
    {
        public Rep_TongHopHoaSinhMau(string[] _arr)
        {
            InitializeComponent();
            arr = _arr;
        }
        public Rep_TongHopHoaSinhMau()
        {
            InitializeComponent();
        }
        ...
        private void ReportHeader_BeforePrint(object sender, CancelEventArgs e)
        {
            ...
            //var dvct1 = (from tn in _Data.TieuNhomDVs.Where(p => p.TenRG.ToLower().Contains("XN hóa sinh máu".ToLower()))
            ...
            //    }
            //}
            var dv = _Data.DichVucts.ToList();
            string madvct = "";
            for (int i = 0; i < 50; i++) {
                string a = i.ToString();
                madvct = arr[i];
                if (dv.Where(p => p.MaDVct== (madvct)).ToList().Count > 0)
                {
                    switch (a)
                    {

                        case "1":
                            txt1.Text = dv.Where(p => p.MaDVct== (madvct)).ToList().First().TenDVct;
                            break;
                        case "2":
                            txt2.Text = dv.Where(p => p.MaDVct== (madvct)).ToList().First().TenDVct;
                            break;
                        case "3":
                            txt3.Text = dv.Where(p => p.MaDVct== (madvct)).ToList().First().TenDVct;
                            break;
                        case "4":
                            txt4.Text = dv.Where(p => p.MaDVct== (madvct)).ToList().First().TenDVct;
                            break;
                        case "5":
                            txt5.Text = dv.Where(p => p.MaDVct== (madvct)).ToList().First().TenDVct;
                            break;
                        case "6":
                            txt6.Text = dv.Where(p => p.MaDVct== (madvct)).ToList().First().TenDVct;
                            break;
                        case "7":
                            txt7.Text = dv.Where(p => p.MaDVct== (madvct)).ToList().First().TenDVct;
                            break;
                        case "8":
                            txt8.Text = dv.Where(p => p.MaDVct== (madvct)).ToList().First().TenDVct;
                            break;
                        case "9":
                            txt9.Text = dv.Where(p => p.MaDVct== (madvct)).ToList().First().TenDVct;
                            break;
                        case "10":
                            txt10.Text = dv.Where(p => p.MaDVct== (madvct)).ToList().First().TenDVct;
                            break;
                        case "11":
                            txt11.Text = dv.Where(p => p.MaDVct== (madvct)).ToList().First().TenDVct;
                            break;
                        case "12":
                            txt12.Text = dv.Where(p => p.MaDVct== (madvct)).ToList().First().TenDVct;
                            break;
                        case "13":
                            txt13.Text = dv.Where(p => p.MaDVct== (madvct)).ToList().First().TenDVct;
                            break;
                        case "14":
                            txt14.Text = dv.Where(p => p.MaDVct== (madvct)).ToList().First().TenDVct;
                            break;
                        case "15":
                            txt15.Text = dv.Where(p => p.MaDVct== (madvct)).ToList().First().TenDVct;
                            break;
                        case "16":
                            txt16.Text = dv.Where(p => p.MaDVct== (madvct)).ToList().First().TenDVct;
                            break;
                        case "17":
                            txt17.Text = dv.Where(p => p.MaDVct== (madvct)).ToList().First().TenDVct;
                            break;
                        case "18":
                            txt18.Text = dv.Where(p => p.MaDVct== (madvct)).ToList().First().TenDVct;
                            break;
                        case "19":
                            txt19.Text = dv.Where(p => p.MaDVct== (madvct)).ToList().First().TenDVct;
                            break;
                        case "20":
                            txt20.Text = dv.Where(p => p.MaDVct== (madvct)).ToList().First().TenDVct;
                            break;
                        case "21":
                            txt21.Text = dv.Where(p => p.MaDVct== (madvct)).ToList().First().TenDVct;
                            break;
                        case "22":
                            txt22.Text = dv.Where(p => p.MaDVct== (madvct)).ToList().First().TenDVct;
                            break;
                        case "23":
                            txt23.Text = dv.Where(p => p.MaDVct== (madvct)).ToList().First().TenDVct;
                            break;
                        case "24":
                            txt24.Text = dv.Where(p => p.MaDVct== (madvct)).ToList().First().TenDVct;
                            break;
                        case "25":
                            txt25.Text = dv.Where(p => p.MaDVct== (madvct)).ToList().First().TenDVct;
                            break;
                        case "26":
                            txt26.Text = dv.Where(p => p.MaDVct== (madvct)).ToList().First().TenDVct;
                            break;
                        case "27":
                            txt27.Text = dv.Where(p => p.MaDVct== (madvct)).ToList().First().TenDVct;
                            break;
                        case "28":
                            txt28.Text = dv.Where(p => p.MaDVct== (madvct)).ToList().First().TenDVct;
                            break;
                        case "29":
                            txt29.Text = dv.Where(p => p.MaDVct== (madvct)).ToList().First().TenDVct;
                            break;
                        case "30":
                            txt30.Text = dv.Where(p => p.MaDVct== (madvct)).ToList().First().TenDVct;
                            break;
                    }
                }
            }
