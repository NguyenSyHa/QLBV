...
{
    public partial class Rep_Thongkethoigiankhamchuabenh_New : DevExpress.XtraReports.UI.XtraReport
    {
        public Rep_Thongkethoigiankhamchuabenh_New()
        {
            InitializeComponent();
        }
      public  string tun;
      public  string denn;
        public void hambctgkb(){
            ...
            celChuyenKhoa.DataBindings.Add("Text", DataSource, "CKhoa");
            SclsTH.DataBindings.Add("Text", DataSource, "CSLTH");
