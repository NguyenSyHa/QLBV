...
{
    public partial class Rep_80a_HD_1399_CongKham_Tyle : DevExpress.XtraReports.UI.XtraReport
    {
        public bool HtTuyen = true;
        int _a = 0;
        public Rep_80a_HD_1399_CongKham_Tyle(int a)
        {
            InitializeComponent();
            _a = a;
            if(DungChung.Bien.MaBV != "24012")
            {
                colGF1Muc.Summary.Running = SummaryRunning.None;
                colGF2Muc.Summary.Running = SummaryRunning.None;
                colRF1.Summary.Running = SummaryRunning.None;
            }
        }
        ...
        public void BindingData(string kieuNT,int a)
        {
            ...
            colTyle.DataBindings.Add("Text", DataSource, "TyLeBHTT");
            ...
            col_tiengiuong.DataBindings.Add("Text", DataSource, "T_giuong").FormatString = DungChung.Bien.FormatString[1];
            ...
            colCKGF1.DataBindings.Add("Text", DataSource, "T_kham").FormatString = DungChung.Bien.FormatString[1];
            ...
            colCKRF1.DataBindings.Add("Text", DataSource, "T_kham").FormatString = DungChung.Bien.FormatString[1];
            ...
            colCPVanchuyenRF1.DataBindings.Add("Text", DataSource, "T_giuong").FormatString = DungChung.Bien.FormatString[1];
            ...
            colGF2CK.DataBindings.Add("Text", DataSource, "T_kham").FormatString = DungChung.Bien.FormatString[1];
            ...
            colGF2Tiengiuong.DataBindings.Add("Text", DataSource, "T_giuong").FormatString = DungChung.Bien.FormatString[1];
