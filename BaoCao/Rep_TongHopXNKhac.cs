...
{
    public partial class Rep_TongHopXNKhac : DevExpress.XtraReports.UI.XtraReport
    {
        public Rep_TongHopXNKhac()
        {
            InitializeComponent();
        }
        ...
        private void ReportHeader_BeforePrint(object sender, CancelEventArgs e)
        {
            ...
            var dvct1 = (from tn in _Data.TieuNhomDVs.Where(p => p.TenRG.ToLower().Contains("XN khác".ToLower()))
