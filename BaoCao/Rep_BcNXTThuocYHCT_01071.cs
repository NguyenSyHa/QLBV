...
{
    public partial class Rep_BcNXTThuocYHCT_01071 : DevExpress.XtraReports.UI.XtraReport
    {
        public Rep_BcNXTThuocYHCT_01071()
        {
            InitializeComponent();
        }
        public  void BindingData()
        {
            colTenHamLuongGh2.DataBindings.Add("Text", DataSource, "TenTieuNhomDuoc");
          ...
          //  colNTruTT.DataBindings.Add("Text", DataSource, "XuatTKSL").FormatString = DungChung.Bien.FormatString[1];
          //  colKhacTT.DataBindings.Add("Text", DataSource, "XuatTKTT").FormatString = DungChung.Bien.FormatString[1];
          ...
          //  colXuatTKTongTTGh2.DataBindings.Add("Text", DataSource, "XuatTKTT").FormatString = DungChung.Bien.FormatString[1];
            ...
            colNgTruSL.DataBindings.Add("Text", DataSource, "SLNGTruTK").FormatString = DungChung.Bien.FormatString[1];
            colNgTruTT.DataBindings.Add("Text", DataSource, "TTNGtruTK").FormatString = DungChung.Bien.FormatString[1];

            colNTruSL.DataBindings.Add("Text", DataSource, "SLNoiTruTK").FormatString = DungChung.Bien.FormatString[1];
            colNTruTT.DataBindings.Add("Text", DataSource, "TTNoiTruTK").FormatString = DungChung.Bien.FormatString[1];

            colKhacSL.DataBindings.Add("Text", DataSource, "SLKhacTK").FormatString = DungChung.Bien.FormatString[1];
            colKhacTT.DataBindings.Add("Text", DataSource, "TTKhacTK").FormatString = DungChung.Bien.FormatString[1];
            ...
            colNGtong1.DataBindings.Add("Text", DataSource, "TTNGtruTK").FormatString = DungChung.Bien.FormatString[1];
            colNTruTong1.DataBindings.Add("Text", DataSource, "TTNoiTruTK").FormatString = DungChung.Bien.FormatString[1];
            colKhacTong1.DataBindings.Add("Text", DataSource, "TTKhacTK").FormatString = DungChung.Bien.FormatString[1];

            colNGTrutong2.DataBindings.Add("Text", DataSource, "TTNGtruTK").FormatString = DungChung.Bien.FormatString[1];
            colNoiTruTong2.DataBindings.Add("Text", DataSource, "TTNoiTruTK").FormatString = DungChung.Bien.FormatString[1];
            colKhacTOng2.DataBindings.Add("Text", DataSource, "TTKhacTK").FormatString = DungChung.Bien.FormatString[1];
