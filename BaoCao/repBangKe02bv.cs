...
{
    public partial class repBangKe02bv : DevExpress.XtraReports.UI.XtraReport
    {
        public repBangKe02bv()
        {
            InitializeComponent();
        }

        public repBangKe02bv(System.Collections.Generic.List<int> lMaThuocHoiChan)
        {
        ...
        private void ReportFooter_BeforePrint(object sender, CancelEventArgs e)
        {
            ...
            else
            {
                ...
                txtTienBN.Text = "- Số tiền người bệnh phải trả: " + DungChung.Ham.DocTienBangChu(Math.Round(Convert.ToDouble(TienBN.Value), 0), " đồng.") + "\nTrong đó:";
                txttutra.Text = "  + Số tiền người bệnh tự trả: " + DungChung.Ham.DocTienBangChu(Math.Round(Convert.ToDouble(Tienbntt.Value), 0), " đồng.");
                txtNguonKhac.Text = "  + Số tiền người bệnh cùng chi trả: " + DungChung.Ham.DocTienBangChu(Math.Round(Convert.ToDouble(TienBnctt.Value), 0), " đồng.");
                txtNguonKhac2.Text = "- Nguồn khác:";
                txtTienBH.Text = "- Số tiền quỹ BHYT thanh toán: " + DungChung.Ham.DocTienBangChu(Math.Round(Convert.ToDouble(TienBH.Value), 0), " đồng.");
            }
            if(DungChung.Bien.MaBV=="30340"||DungChung.Bien.MaBV=="30005")
            {
                txtTenGiamDinhBH.Visible = true;
                txtTenGiamDinhBH.Text = DungChung.Bien.GiamDinhBH2;
            }
