...
{
    public partial class repBcNoiTruThangct_HA : DevExpress.XtraReports.UI.XtraReport
    {
        public repBcNoiTruThangct_HA()
        {
            InitializeComponent();
        }
        ...
        public void BindingData()
        {
            ...
            colTreEm.DataBindings.Add("Text", DataSource, "TongSoLKTE1").FormatString = DungChung.Bien.FormatString[1];
            ...
            colThanhTienT.DataBindings.Add("Text", DataSource, "TongTien1").FormatString = DungChung.Bien.FormatString[1];
            colThanhTien.DataBindings.Add("Text", DataSource, "TongTien1").FormatString = DungChung.Bien.FormatString[1];
        }
