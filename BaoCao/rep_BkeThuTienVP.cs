...
{
    public partial class rep_BkeThuTienVP : DevExpress.XtraReports.UI.XtraReport
    {
        public static DateTime tungay;
        public static DateTime denngay;
        QLBV_Database.QLBVEntities data;
        public rep_BkeThuTienVP()
        {
            InitializeComponent();
        ...
        internal void BindingData()
        {
            ...
            colTongSo.DataBindings.Add("Text", DataSource, "TongCong1").FormatString = DungChung.Bien.FormatString[1];
            colTong.DataBindings.Add("Text", DataSource, "TongCong1").FormatString = DungChung.Bien.FormatString[1];
