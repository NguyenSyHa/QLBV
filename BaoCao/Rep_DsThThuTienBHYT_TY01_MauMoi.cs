...
{
    public partial class Rep_DsThThuTienBHYT_TY01_MauMoi : DevExpress.XtraReports.UI.XtraReport
    {
        public Rep_DsThThuTienBHYT_TY01_MauMoi()
        {
            InitializeComponent();
        }
        public void BindingData()
        {
            ...
            clNgay.DataBindings.Add("Text", DataSource, "Ngay").FormatString = "{0:dd/MM/yyyy}";
            ...
            clGrTongtien.DataBindings.Add("Text", DataSource, "TongTien");
            clGrSoTienNop.DataBindings.Add("Text", DataSource, "SoTienNop");
