...
{
    public partial class Rep_Bke_New_2018TK_InDoc : DevExpress.XtraReports.UI.XtraReport
    {
        int _idper = 0, _mabn = 0;
        DateTime _ngayTachThe;
        // thông tin thẻ mới
        string sthe = "";
        string tenBN = "";
        string diaChi = "";
        ...
        string ngayUpdate = "";
        //
        public Rep_Bke_New_2018TK_InDoc(int idper, int mabn)
        {
            InitializeComponent();
            _idper = idper;
            _mabn = mabn;
        ...
        public void Bindingdata()
        {
            ...
            {
                PageFooter.PrintOn = PrintOnPages.NotWithReportHeader;
            }
            if (DungChung.Bien.MaBV == "24272")
            {
                sub_dt_24272.Visible = true;
                SubBand2.Visible = false;
                celTenDV_24272.DataBindings.Add("Text", DataSource, "TenDV");
                celDonVi_24272.DataBindings.Add("Text", DataSource, "DonVi");
                celSoLuong_24272.DataBindings.Add("Text", DataSource, "SoLuong").FormatString = DungChung.Bien.FormatString[0];
                celDonGiaBV_24272.DataBindings.Add("Text", DataSource, "DonGiaBV").FormatString = DungChung.Bien.FormatString[1];
                celDonGiaBH_24272.DataBindings.Add("Text", DataSource, "DonGiaBH").FormatString = DungChung.Bien.FormatString[1];
                celTyLeDV_24272.DataBindings.Add("Text", DataSource, "TyLeTTDV");

                celThanhTienBV_24272.DataBindings.Add("Text", DataSource, "ThanhTienBV").FormatString = DungChung.Bien.FormatString[1];
                celThanhTianBV_T_24272.DataBindings.Add("Text", DataSource, "ThanhTienBV");
                celThanhTianBV_T_24272.Summary.FormatString = DungChung.Bien.FormatString[1];
                celTTBV_G2_24272.DataBindings.Add("Text", DataSource, "ThanhTienBV");
                celTTBV_G2_24272.Summary.FormatString = DungChung.Bien.FormatString[1];
                celTTBV_G1_24272.DataBindings.Add("Text", DataSource, "ThanhTienBV");
                celTTBV_G1_24272.Summary.FormatString = DungChung.Bien.FormatString[1];
                celTTBV_G0_24272.DataBindings.Add("Text", DataSource, "ThanhTienBV");
                celTTBV_G0_24272.Summary.FormatString = DungChung.Bien.FormatString[1];

                celThanhTienBH_24272.DataBindings.Add("Text", DataSource, "ThanhTienBH").FormatString = DungChung.Bien.FormatString[1];
                celThanhTienBH_T_24272.DataBindings.Add("Text", DataSource, "ThanhTienBH");
                celThanhTienBH_T_24272.Summary.FormatString = DungChung.Bien.FormatString[1];
                celTTBH_G_24272.DataBindings.Add("Text", DataSource, "ThanhTienBH");
                celTTBH_G_24272.Summary.FormatString = DungChung.Bien.FormatString[1];
                celTTBH_G1_24272.DataBindings.Add("Text", DataSource, "ThanhTienBH");
                celTTBH_G1_24272.Summary.FormatString = DungChung.Bien.FormatString[1];
                celTTBH_G0_24272.DataBindings.Add("Text", DataSource, "ThanhTienBH");
                celTTBH_G0_24272.Summary.FormatString = DungChung.Bien.FormatString[1];

                celTyLeBH_24272.DataBindings.Add("Text", DataSource, "TyLeTTBH");
                celTienBH_24272.DataBindings.Add("Text", DataSource, "TienBH").FormatString = DungChung.Bien.FormatString[1];
                celTienBH_T_24272.DataBindings.Add("Text", DataSource, "TienBH");
                celTienBH_T_24272.Summary.FormatString = DungChung.Bien.FormatString[1];
                celTienBH_G_24272.DataBindings.Add("Text", DataSource, "TienBH");
                celTienBH_G_24272.Summary.FormatString = DungChung.Bien.FormatString[1];
                celTienBH_G1_24272.DataBindings.Add("Text", DataSource, "TienBH");
                celTienBH_G1_24272.Summary.FormatString = DungChung.Bien.FormatString[1];
                celTienBH_G0_24272.DataBindings.Add("Text", DataSource, "TienBH");
                celTienBH_G0_24272.Summary.FormatString = DungChung.Bien.FormatString[1];

                celTienBN_24272.DataBindings.Add("Text", DataSource, "TienBN").FormatString = DungChung.Bien.FormatString[1];
                celTienBN_T_24272.DataBindings.Add("Text", DataSource, "TienBN");
                celTienBN_T_24272.Summary.FormatString = DungChung.Bien.FormatString[1];
                celTienBN_G_24272.DataBindings.Add("Text", DataSource, "TienBN");
                celTienBN_G_24272.Summary.FormatString = DungChung.Bien.FormatString[1];
                celTienBN_G1_24272.DataBindings.Add("Text", DataSource, "TienBN");
                celTienBN_G1_24272.Summary.FormatString = DungChung.Bien.FormatString[1];
                celTienBN_G0_24272.DataBindings.Add("Text", DataSource, "TienBN");
                celTienBN_G0_24272.Summary.FormatString = DungChung.Bien.FormatString[1];

                celTienNGDM_24272.DataBindings.Add("Text", DataSource, "TienNgBH").FormatString = DungChung.Bien.FormatString[1];
                celTienNGDM_T_24272.DataBindings.Add("Text", DataSource, "TienNgBH");
                celTienNGDM_T_24272.Summary.FormatString = DungChung.Bien.FormatString[1];
                celTienNGDM_G_24272.DataBindings.Add("Text", DataSource, "TienNgBH");
                celTienNGDM_G_24272.Summary.FormatString = DungChung.Bien.FormatString[1];
                celTienNGDM_G1_24272.DataBindings.Add("Text", DataSource, "TienNgBH");
                celTienNGDM_G1_24272.Summary.FormatString = DungChung.Bien.FormatString[1];
                celTienNGDM_G0_24272.DataBindings.Add("Text", DataSource, "TienNgBH");
                celTienNGDM_G0_24272.Summary.FormatString = DungChung.Bien.FormatString[1];

                coltienkhac_24272.DataBindings.Add("Text", DataSource, "TienKhac").FormatString = DungChung.Bien.FormatString[1];
                coltienkhac_R_24272.DataBindings.Add("Text", DataSource, "TienKhac");
                coltienkhac_R_24272.Summary.FormatString = DungChung.Bien.FormatString[1];
                coltienkhac_G_24272.DataBindings.Add("Text", DataSource, "TienKhac");
                coltienkhac_G_24272.Summary.FormatString = DungChung.Bien.FormatString[1];
                coltienkhac_G1_24272.DataBindings.Add("Text", DataSource, "TienKhac");
                coltienkhac_G1_24272.Summary.FormatString = DungChung.Bien.FormatString[1];
                coltienkhac_G0_24272.DataBindings.Add("Text", DataSource, "TienKhac");
                coltienkhac_G0_24272.Summary.FormatString = DungChung.Bien.FormatString[1];

                txtNguoiLap_24272.Text = DungChung.Bien.NguoiLapBieu;

                celNhom_24272.DataBindings.Add("Text", DataSource, "TenNhom");
                celTieuNhom_24272.DataBindings.Add("Text", DataSource, "TenTieuNhom");
                celDongY_24272.DataBindings.Add("Text", DataSource, "TenDongTayY");
        ...
        private void GroupHeader2_BeforePrint(object sender, CancelEventArgs e)
        {
            if (this.GetCurrentColumnValue("STTNhom") != null)
            {
                ...
                if (DungChung.Bien.MaBV == "24272")
                {
                    sub_gr2_24272.Visible = true;
                    SubBand6.Visible = false;
                    if (n == "2" || n == "11")
                    {
                        GroupHeader1.Visible = true;
                        celTienBH_G_24272.Text = "";
                        celTTBV_G2_24272.Text = "";
                        celTTBH_G_24272.Text = "";
                        celTienBN_G_24272.Text = "";
                        celTienNGDM_G_24272.Text = "";
                    }
                    else if (n == "5")
                    {
        ...
        private void ReportHeader_BeforePrint(object sender, CancelEventArgs e)
        {
            if (DungChung.Bien.MaBV == "24012")
            {
                ...
                //xrLine13.Visible = false;
                //xrLine14.Visible = false;
                //xrLine15.Visible = false;
                //xrLine16.Visible = false;
                //xrLine19.Visible = false;
                //xrLine20.Visible = false;
            ...
            {
                xrLabel48.Borders = DevExpress.XtraPrinting.BorderSide.None;
                xrLabel50.Borders = DevExpress.XtraPrinting.BorderSide.None;
            }
            ...
            if (DungChung.Bien.MaBV == "24272")
            {
                ...
                sub_rb_24272.Visible = true;
                sub24272.Visible = true;
            }
        }
        ...
        private void Rep_Bke_New_2018TK_InDoc_BeforePrint(object sender, CancelEventArgs e)
        {
            ...
            if (DungChung.Bien.MaBV == "24012")
            {
                celDonGiaBV.NullValueText = "0";
                celDonGiaBH.NullValueText = "0";
                celTyLeDV.NullValueText = "0";
                celThanhTienBV.NullValueText = "0";
                celTyLeBH.NullValueText = "0";
                celThanhTienBH.NullValueText = "0";
                celTienBH.NullValueText = "0";
                celTienBN.NullValueText = "0";
                coltienkhac.NullValueText = "0";
                celTienNGDM.NullValueText = "0";
            }
        }
        ...
        private void _InSubReport(XRSubreport repsub)
        {
            ...
            if (!string.IsNullOrEmpty(_lTttbx.TTTheBHYTold) && _lTttbx.TTTheBHYTold.Contains(';'))
            {
                ...
                hanBHDen = listTTBS[6];
                maDKKCB = listTTBS[7];
                ngayUpdate = listTTBS[8];
                _ngayTachThe = DungChung.Ham.NgayTu(Convert.ToDateTime(hanBHTu));
            }
            else
            {
                return;
            ...
            var dichvu = (from dv in _dataContext.DichVus
                          ...
                          select new { dv.SoTT, dv.TrongDM, dv.MaDV, dv.DonGia, dv.DonGia2, dv.DonGiaBHYT, dv.DonGiaDV2, dv.GiaBHGioiHanTT, TenRGTN = tn.TenRG, dv.TenHC, dv.HamLuong, dv.MaQD, dv.SoQD, nhomdv.TenNhom, nhomdv.TenNhomCT, nhomdv.STT, dv.TenDV, dv.DonVi, dv.TenRG, nhomdv.IDNhom, dv.DongY }).ToList();
            var _ldvbn1 = (from vp in _dataContext.VienPhis.Where(p => p.MaBNhan == _mabn)
                           join vpct in _dataContext.VienPhicts.Where(p => (DungChung.Bien.MaBV == "01071" || DungChung.Bien.MaBV == "01071") ? (p.TrongBH == 1) : (p.TrongBH != 2 && p.TrongBH != 3)).Where(p => p.ThanhToan == 0).Where(p => p.AttachIDDonct == null).Where(p => p.NgayYLenh >= _ngayTachThe) on vp.idVPhi equals vpct.idVPhi
                           select new
                           {
                               vp.MaBNhan,
                               vp.NgayTT,
            ...
            else if (hanBHTu != null)
            {
                DateTime date = DateTime.Parse(hanBHTu);
                rep.CPKCB.Value = "Chi phí KCB tính từ ngày " + date.ToShortDateString() + " đến ngày " + _lrv.NgayRa.Value.ToShortDateString();
            }



            if (!string.IsNullOrEmpty(sthe) && sthe.Length >= 15)
            {
                xrSubreport1.Visible = true;
                rep.THE1.Value = sthe.Substring(0, 2);
                rep.THE2.Value = sthe.Substring(2, 1);
                rep.THE3.Value = sthe.Substring(3, 2);
                rep.THE4.Value = sthe.Substring(5);
                _muc = sthe.Substring(2, 1);
                rep.GIOIHANTHE.Value = "Giá trị từ " + hanBHTu + " đến " + hanBHDen;
            }

            int _hangbv = DungChung.Ham.hangBV(DungChung.Bien.MaBV);
            rep.MUCHUONG.Value = DungChung.Ham.TinhMucHuong(dungtuyen, _muc, _Benhnhan.KhuVuc, tongcp1, _hangbv, _Benhnhan.NoiTru ?? 0, _Benhnhan.SThe, _Benhnhan.MaCS) + "%";
            ...
            var _lcongkham = (from vp in _ldvbn
                              ...
                              select new { vp, dv.TenNhom, dv.DonGia, dv.DonGia2, dv.DonGiaBHYT, dv.DonGiaDV2, dv.TenDV, vp.TyLeBHTT }).ToList();
            if (_lcongkham.Count > 0)
            {
                foreach (var item in _lcongkham)
                {
                    ...
                    if (item.vp.TrongBH == 1)
                    {
                        ...
                        moi.ThanhTienBV = Math.Round(item.vp.DonGia * item.vp.SoLuong, DungChung.Bien.LamTronSo);
                        ...
                        else if (DungChung.Bien.MaBV == "27023" || DungChung.Bien.MaBV == "01071")
                        {
                            moi.TyLeTTBH = item.vp.TyLeTT;
                        }
                        else
                        {
                            moi.TyLeTTBH = item.TyLeBHTT;
                        }
                    }
                    else
                    {
            ...
            var _lngaygiuong = (from vp in _ldvbn
                                ...
                                select new { vp, dv.TenNhom, dv.DonGia, dv.DonGia2, dv.DonGiaBHYT, dv.DonGiaDV2, dv.TenDV, dv.IDNhom, vp.TyLeBHTT }).ToList();
            ...
            var _lvtyt = (from vp in _ldvbn
                          ...
                          select new { vp, dv.TenNhom, dv.DonGia, dv.DonGia2, dv.DonGiaBHYT, dv.DonGiaDV2, dv.TenDV, dv.MaDV, dv.GiaBHGioiHanTT, vp.TyLeBHTT }).ToList();
            if (_lvtyt.Count > 0)
            {
            ...
            var _lvtytgoi = (from vp in _ldvbngoi.Where(p => p.AttachIDDonct != null && p.AttachIDDonct > 0)
                             join dv in dichvu.Where(p => p.IDNhom == 10 || p.IDNhom == 11) on vp.MaDV equals dv.MaDV
                             select new { vp, dv.TenNhom, dv.DonGia, dv.DonGia2, dv.DonGiaBHYT, dv.DonGiaDV2, dv.GiaBHGioiHanTT, dv.TenDV, vp.MaDV, vp.AttachIDDonct, vp.ThanhTien, vp.TyLeBHTT }).ToList();
            ...
            var _thuocgoi = (from vp in _ldvbngoi.Where(p => p.AttachIDDonct != null && p.AttachIDDonct > 0)
                             join dv in dichvu.Where(p => p.IDNhom == 5 || p.IDNhom == 6 || p.IDNhom == 4) on vp.MaDV equals dv.MaDV
                             select new { vp, dv.TenNhom, dv.DonGia, dv.DonGia2, dv.DonGiaBHYT, dv.DonGiaDV2, dv.TenDV, dv.DongY, vp.TyLeBHTT }).ToList();
        ...
        {
            var _dataContext = new QLBV_Database.QLBVEntities(DungChung.Bien.StrCon);
            ...
            if (DungChung.Bien.MaBV == "30003" && _bnkb.Count > 0)
            {
                txtNguoiLap.Text = _bnkb.Last().TenCB;

            }
            else if (DungChung.Bien.MaBV == "24272")
            {
                sub_rf_24272.Visible = true;
        ...
        private void xrSubreport2_BeforePrint_1(object sender, CancelEventArgs e)
        {
