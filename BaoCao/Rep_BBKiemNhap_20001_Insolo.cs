...
{
    public partial class Rep_BBKiemNhap_20001_Insolo : DevExpress.XtraReports.UI.XtraReport
    {
        public Rep_BBKiemNhap_20001_Insolo()
        {
            InitializeComponent();
        }
        public void BindingData()
        {
            ...
            cel_ttong.Summary.FormatString = DungChung.Bien.FormatString[1];
            cel_ttsauthue.Summary.FormatString = DungChung.Bien.FormatString[1];
        ...
        private void ReportFooter_BeforePrint(object sender, CancelEventArgs e)
        {
            if(DungChung.Bien.MaBV == "20001")
                xrTableCell50.Text = "TRƯỞNG KHOA DƯỢC";
        }
